...
static mut rar5_signature_xor: [libc::c_uchar; 8] =
    [243 as libc::c_int as libc::c_uchar, 192 as libc::c_int as libc::c_uchar,
        211 as libc::c_int as libc::c_uchar, 128 as libc::c_int as libc::c_uchar,
        187 as libc::c_int as libc::c_uchar, 166 as libc::c_int as libc::c_uchar,
...
extern "C" fn cdeque_clear(mut d: *mut cdeque) {
...
extern "C" fn cdeque_init(mut d: *mut cdeque,
    ...
    if max_capacity_power_of_2 & safe_d.cap_mask as libc::c_int !=
        0 as libc::c_int {
        return CDE_PARAM as libc::c_int;
    }
    cdeque_clear(d);
    safe_d.arr =
        malloc_safe((::std::mem::size_of::<*mut libc::c_void>() as
            libc::c_ulong).wrapping_mul(max_capacity_power_of_2 as
            libc::c_ulong)) as
            *mut size_t;
    return if !safe_d.arr.is_null() {
        CDE_OK as libc::c_int
    } else { CDE_ALLOC as libc::c_int };
}
/* Return the current size (not capacity) of circular deque `d`. */
extern "C" fn cdeque_size(mut d: *mut cdeque) -> size_t {
    let safe_d = unsafe { &mut *d };
...
extern "C" fn cdeque_front_fast(mut d: *mut cdeque,
...
extern "C" fn cdeque_front(mut d: *mut cdeque,
                           mut value: *mut *mut libc::c_void)
                           -> libc::c_int {
    let safe_d = unsafe { &mut *d };
    ...
    } else { return CDE_OUT_OF_BOUNDS as libc::c_int; };
}
...
extern "C" fn cdeque_push_back(mut d: *mut cdeque,
                               mut item: *mut libc::c_void)
                               -> libc::c_int {
    if d.is_null() { return CDE_PARAM as libc::c_int; }
    let safe_d = unsafe { &mut *d };
    if safe_d.size as libc::c_int ==
        safe_d.cap_mask as libc::c_int + 1 as libc::c_int {
        return CDE_OUT_OF_BOUNDS as libc::c_int;
    }
    unsafe { *(*d).arr.offset((*d).end_pos as isize) = item as size_t };
    safe_d.end_pos =
        (safe_d.end_pos as libc::c_int + 1 as libc::c_int &
...
extern "C" fn cdeque_pop_front_fast(mut d: *mut cdeque,
                                    mut value:
                                    *mut *mut libc::c_void) {
    let safe_d = unsafe { &mut *d };
    let safe_value = unsafe { &mut *value };
    unsafe { *safe_value = *(*d).arr.offset(safe_d.beg_pos as isize) as *mut libc::c_void };
    safe_d.beg_pos =
        (safe_d.beg_pos as libc::c_int + 1 as libc::c_int &
            safe_d.cap_mask as libc::c_int) as uint16_t;
    safe_d.size = safe_d.size.wrapping_sub(1);
}
/* Pops a front element of this circular deque object and returns its value.
 * This function performs bounds checking. */
extern "C" fn cdeque_pop_front(mut d: *mut cdeque,
                               mut value: *mut *mut libc::c_void)
                               -> libc::c_int {
    let safe_d = unsafe { &mut *d };
    if d.is_null() || value.is_null() { return CDE_PARAM as libc::c_int; }
    if safe_d.size as libc::c_int == 0 as libc::c_int {
        return CDE_OUT_OF_BOUNDS as libc::c_int;
    }
...
extern "C" fn cdeque_filter_p(mut f: *mut *mut filter_info)
                              -> *mut *mut libc::c_void {
    return f as size_t as *mut *mut libc::c_void;
}
/* Convenience function to cast filter_info* to void *. */
extern "C" fn cdeque_filter(mut f: *mut filter_info)
                            -> *mut libc::c_void {
...
extern "C" fn cdeque_free(mut d: *mut cdeque) {
    if d.is_null() { return; }
    let safe_d = unsafe { &mut *d };
    if safe_d.arr.is_null() { return; }
...
#[inline]
extern "C" fn bf_bit_size(mut hdr: *const compressed_block_header)
                          -> uint8_t {
    return unsafe {
        ((*hdr).block_flags_u8 as libc::c_int & 7 as libc::c_int) as
            uint8_t
    };
}

#[inline]
extern "C" fn bf_byte_count(mut hdr: *const compressed_block_header)
                            -> uint8_t {
    return unsafe {
        ((*hdr).block_flags_u8 as libc::c_int >> 3 as libc::c_int &
            7 as libc::c_int) as uint8_t
    };
}

#[inline]
extern "C" fn bf_is_table_present(mut hdr:
                                  *const compressed_block_header)
                                  -> uint8_t {
    return unsafe {
        ((*hdr).block_flags_u8 as libc::c_int >> 7 as libc::c_int &
            1 as libc::c_int) as uint8_t
    };
}

#[inline]
extern "C" fn get_context(mut a: *mut archive_read) -> *mut rar5 {
    return unsafe { (*(*a).format).data as *mut rar5 };
}
/* Convenience functions used by filter implementations. */
extern "C" fn circular_memcpy(mut dst: *mut uint8_t,
                              mut window: *mut uint8_t, mask: uint64_t,
                              mut start: int64_t, mut end: int64_t) {
    if start as libc::c_ulong & mask > end as libc::c_ulong & mask {
        let mut len1: ssize_t =
            mask.wrapping_add(1 as libc::c_int as
                libc::c_ulong).wrapping_sub(start as
                libc::c_ulong
                & mask) as
                ssize_t;
        let mut len2: ssize_t = (end as libc::c_ulong & mask) as ssize_t;
        memcpy_safe(dst as *mut libc::c_void,
                    unsafe {
                        &mut *window.offset((start as libc::c_ulong & mask) as isize)
                            as *mut uint8_t as *const libc::c_void
                    },
                    len1 as libc::c_ulong);
        memcpy_safe(unsafe { dst.offset(len1 as isize) as *mut libc::c_void },
                    window as *const libc::c_void, len2 as libc::c_ulong);
    } else {
        memcpy_safe(dst as *mut libc::c_void,
                    unsafe {
                        &mut *window.offset((start as libc::c_ulong & mask) as isize)
...
extern "C" fn read_filter_data(mut rar: *mut rar5,
                               mut offset: uint32_t) -> uint32_t {
    let mut linear_buf: [uint8_t; 4] = [0; 4];
    let safe_rar = unsafe { &mut *rar };
    circular_memcpy(linear_buf.as_mut_ptr(), safe_rar.cstate.window_buf,
                    safe_rar.cstate.window_mask, offset as int64_t,
                    offset.wrapping_add(4 as libc::c_int as libc::c_uint) as
                        int64_t);
    return archive_le32dec(linear_buf.as_mut_ptr() as *const libc::c_void);
}

extern "C" fn write_filter_data(mut rar: *mut rar5,
                                mut offset: uint32_t,
                                mut value: uint32_t) {
    archive_le32enc(unsafe {
        &mut *(*rar).cstate.filtered_buf.offset(offset as isize)
            as *mut uint8_t as *mut libc::c_void
    }, value);
}
/* Allocates a new filter descriptor and adds it to the filter array. */
extern "C" fn add_new_filter(mut rar: *mut rar5) -> *mut filter_info {
    let safe_rar = unsafe { &mut *rar };
    let mut f: *mut filter_info =
        calloc_safe(1 as libc::c_int as libc::c_ulong,
                    ::std::mem::size_of::<filter_info>() as libc::c_ulong) as
            *mut filter_info;
    if f.is_null() { return 0 as *mut filter_info; }
    cdeque_push_back(&mut safe_rar.cstate.filters, cdeque_filter(f));
    return f;
}

extern "C" fn run_delta_filter(mut rar: *mut rar5,
    ...
    while i < safe_flt.channels {
        ...
        while dest_pos < safe_flt.block_length {
            ...
            unsafe {
                byte =
                    *(*rar).cstate.window_buf.offset(((safe_rar.cstate.solid_offset
            ...
            prev_byte =
                (prev_byte as libc::c_int - byte as libc::c_int) as uint8_t;
...
extern "C" fn run_e8e9_filter(mut rar: *mut rar5,
                              mut flt: *mut filter_info,
    ...
    let safe_rar = unsafe { &mut *rar };
    let safe_flt = unsafe { &mut *flt };
    circular_memcpy(safe_rar.cstate.filtered_buf, safe_rar.cstate.window_buf,
                    safe_rar.cstate.window_mask,
                    safe_rar.cstate.solid_offset + safe_flt.block_start,
                    safe_rar.cstate.solid_offset + safe_flt.block_start +
                        safe_flt.block_length);
 ...
 */
        if b as libc::c_int == 0xe8 as libc::c_int ||
            ...
            let mut offset: uint32_t =
                ((i + safe_flt.block_start) % file_size as libc::c_long) as
                    uint32_t;
            addr =
                read_filter_data(rar,
                                 ((safe_rar.cstate.solid_offset +
                                     safe_flt.block_start + i) as uint32_t as
                                     libc::c_ulong &
            ...
            if addr & 0x80000000 as libc::c_uint != 0 {
                if addr.wrapping_add(offset) & 0x80000000 as libc::c_uint ==
                    ...
                    write_filter_data(rar, i as uint32_t,
                                      addr.wrapping_add(file_size));
                }
            } else if addr.wrapping_sub(file_size) &
...
extern "C" fn run_arm_filter(mut rar: *mut rar5,
                             mut flt: *mut filter_info)
                             -> libc::c_int {
    ...
    while i < safe_flt.block_length - 3 as libc::c_int as libc::c_long {
        let mut b: *mut uint8_t = unsafe {
            &mut *(*rar).cstate.window_buf.offset(((safe_rar.cstate.solid_offset
                + safe_flt.block_start +
                i +
                3 as libc::c_int as
                    libc::c_long) as
        ...
        if *safe_b as libc::c_int == 0xeb as libc::c_int {
            ...
            offset =
                read_filter_data(rar,
                                 ((safe_rar.cstate.solid_offset +
                                     safe_flt.block_start + i) as
                                     libc::c_ulong &
                                     safe_rar.cstate.window_mask) as uint32_t)
                    & 0xffffff as libc::c_int as libc::c_uint;
            offset =
                (offset as
                    libc::c_uint).wrapping_sub(((i + safe_flt.block_start) /
                    4 as libc::c_int as
                        libc::c_long) as
                    uint32_t) as uint32_t as
                    uint32_t;
            offset =
                offset & 0xffffff as libc::c_int as libc::c_uint |
                    0xeb000000 as libc::c_uint;
...
extern "C" fn run_filter(mut a: *mut archive_read,
                         mut flt: *mut filter_info) -> libc::c_int {
    ...
    if safe_rar.cstate.filtered_buf.is_null() {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ...
                          b"Can\'t allocate memory for filter data.\x00" as
    ...
    match safe_flt.type_0 {
        ...
        1 | 2 => {
            /* fallthrough */
            ret =
                run_e8e9_filter(rar, flt,
                                (safe_flt.type_0 == FILTER_E8E9 as libc::c_int)
                                    as libc::c_int)
        }
        ...
        _ => {
            archive_set_error_safe!(&mut (*a).archive as *mut archive,
                              ...
                              b"Unsupported filter type: 0x%x\x00" as
                                  *const u8 as *const libc::c_char,
                              (*flt).type_0);
            return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
        }
    ...
    if ARCHIVE_RAR5_DEFINED_PARAM.archive_ok !=
        push_data_ready(a, rar, safe_rar.cstate.filtered_buf,
                        safe_flt.block_length as size_t,
                        safe_rar.cstate.last_write_ptr)
    {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Stack overflow when submitting unpacked data\x00"
...
extern "C" fn push_data(mut a: *mut archive_read, mut rar: *mut rar5,
                        mut buf: *const uint8_t,
                        mut idx_begin: int64_t, mut idx_end: int64_t) {
    let safe_rar = unsafe { &mut *rar };
    let wmask: uint64_t = safe_rar.cstate.window_mask;
    let solid_write_ptr: ssize_t =
        ((safe_rar.cstate.solid_offset + safe_rar.cstate.last_write_ptr) as
            libc::c_ulong & wmask) as ssize_t;
    ...
    if idx_begin as libc::c_ulong & wmask > idx_end as libc::c_ulong & wmask {
        ...
        let frag1_size: ssize_t =
            (safe_rar.cstate.window_size as
                libc::c_ulong).wrapping_sub(idx_begin as libc::c_ulong &
                wmask) as ssize_t;
        let frag2_size: ssize_t =
            (idx_end as libc::c_ulong & wmask) as ssize_t;
        /* Copy the first part of the buffer first. */
        push_data_ready(a, rar, unsafe { buf.offset(solid_write_ptr as isize) },
                        frag1_size as size_t, safe_rar.cstate.last_write_ptr);
        /* Copy the second part of the buffer. */

        push_data_ready(a, rar, buf, frag2_size as size_t,
...
extern "C" fn push_window_data(mut a: *mut archive_read,
                               mut rar: *mut rar5,
...
extern "C" fn apply_filters(mut a: *mut archive_read) -> libc::c_int {
    let mut flt: *mut filter_info = 0 as *mut filter_info;
    let mut rar: *mut rar5 = get_context(a);
    let mut ret: libc::c_int = 0;
    unsafe { (*rar).cstate.set_all_filters_applied(0 as libc::c_int as uint8_t) };
    ...
    if CDE_OK as libc::c_int ==
        cdeque_front(&mut unsafe { (*rar).cstate.filters }, cdeque_filter_p(&mut flt))
    {
        unsafe {
                    ...
                    (*flt).block_start + (*flt).block_length
            {
                ...
                if (*rar).cstate.last_write_ptr == (*flt).block_start {
                    ...
                    cdeque_pop_front(&mut (*rar).cstate.filters,
    ...
    unsafe { (*rar).cstate.set_all_filters_applied(1 as libc::c_int as uint8_t) };
    return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok;
}

extern "C" fn dist_cache_push(mut rar: *mut rar5,
...
extern "C" fn dist_cache_touch(mut rar: *mut rar5,
...
extern "C" fn free_filters(mut rar: *mut rar5) {
    let safe_rar = unsafe { &mut *rar };
    ...
    while cdeque_size(d) > 0 as libc::c_int as libc::c_ulong {
        ...
        if CDE_OK as libc::c_int ==
            cdeque_pop_front(d, cdeque_filter_p(&mut f)) {
...
extern "C" fn reset_file_context(mut rar: *mut rar5) {
    let safe_rar = unsafe { &mut *rar };
    memset_safe(&mut safe_rar.file as *mut file_header as *mut libc::c_void,
                0 as libc::c_int,
    ...
    } else { safe_rar.cstate.solid_offset = 0 as libc::c_int as int64_t }
...
#[inline]
extern "C" fn get_archive_read(mut a: *mut archive,
                               mut ar: *mut *mut archive_read)
                               -> libc::c_int {
    unsafe { *ar = a as *mut archive_read };
    let mut magic_test: libc::c_int =
        __archive_check_magic_safe(a, 0xdeb0c5 as libc::c_uint, 1 as libc::c_uint,
                                   b"archive_read_support_format_rar5\x00" as
                                       *const u8 as *const libc::c_char);
    if magic_test == ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal { return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal; }
    return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok;
}

extern "C" fn read_ahead(mut a: *mut archive_read,
                         mut how_many: size_t,
                         mut ptr: *mut *const uint8_t) -> libc::c_int {
    ...
    *safe_ptr = __archive_read_ahead_safe(a, how_many, &mut avail) as *const uint8_t;
    if safe_ptr.is_null() { return 0 as libc::c_int; }
    return 1 as libc::c_int;
}

extern "C" fn consume(mut a: *mut archive_read, mut how_many: int64_t)
                      -> libc::c_int {
    let mut ret: libc::c_int = 0;
    ret =
        if how_many == __archive_read_consume_safe(a, how_many) {
            ARCHIVE_RAR5_DEFINED_PARAM.archive_ok
        } else { ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal };
    return ret;
}
/* *
 ...
 *           invalid value.
 */
extern "C" fn read_var(mut a: *mut archive_read,
                       mut pvalue: *mut uint64_t,
                       mut pvalue_len: *mut uint64_t) -> libc::c_int {
    ...
    while i < 8 as libc::c_int as libc::c_ulong {
        ...
        result =
            (result as
                libc::c_ulong).wrapping_add((b as libc::c_ulong &
        ...
        if b as libc::c_int & 0x80 as libc::c_int == 0 as libc::c_int {
            if !pvalue.is_null() { *safe_pvalue = result }
            ...
            if !pvalue_len.is_null() {
                *safe_pvalue_len =
                    (1 as libc::c_int as libc::c_ulong).wrapping_add(i)
        ...
        shift =
            (shift as
                libc::c_ulong).wrapping_add(7 as libc::c_int as
...
extern "C" fn read_var_sized(mut a: *mut archive_read,
    ...
    let ret: libc::c_int =
        ...
        } else { read_var(a, &mut v, 0 as *mut uint64_t) };
    if ret == 1 as libc::c_int && !pvalue.is_null() { *safe_pvalue = v }
    if !pvalue_len.is_null() {
...
extern "C" fn read_bits_32(mut rar: *mut rar5, mut p: *const uint8_t,
                           mut value: *mut uint32_t) -> libc::c_int {
    let safe_rar = unsafe { &mut *rar };
    let safe_value = unsafe { &mut *value };
    let mut bits: uint32_t =
        unsafe {
            (*p.offset(safe_rar.bits.in_addr as isize) as uint32_t) <<
                24 as libc::c_int
        };
    unsafe {
        bits |=
            ((*p.offset((safe_rar.bits.in_addr + 1 as libc::c_int) as isize) as
                libc::c_int) << 16 as libc::c_int) as libc::c_uint;
        bits |=
            ((*p.offset((safe_rar.bits.in_addr + 2 as libc::c_int) as isize) as
                libc::c_int) << 8 as libc::c_int) as libc::c_uint;
        bits |=
            *p.offset((safe_rar.bits.in_addr + 3 as libc::c_int) as isize) as
                libc::c_uint;
        bits <<= safe_rar.bits.bit_addr as libc::c_int;
        bits |=
            (*p.offset((safe_rar.bits.in_addr + 4 as libc::c_int) as isize) as
                libc::c_int >>
                8 as libc::c_int - safe_rar.bits.bit_addr as libc::c_int) as
                libc::c_uint;
    }
    *safe_value = bits;
    return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok;
...
extern "C" fn read_bits_16(mut rar: *mut rar5, mut p: *const uint8_t,
                           mut value: *mut uint16_t) -> libc::c_int {
    let safe_rar = unsafe { &mut *rar };
    let safe_value = unsafe { &mut *value };
    let mut bits: libc::c_int =
        unsafe {
            (*p.offset(safe_rar.bits.in_addr as isize) as uint32_t as libc::c_int)
                << 16 as libc::c_int
        };
    unsafe {
        bits |=
...
extern "C" fn skip_bits(mut rar: *mut rar5, mut bits: libc::c_int) {
    let safe_rar = unsafe { &mut *rar };
...
/* n = up to 16 */
extern "C" fn read_consume_bits(mut rar: *mut rar5,
                                mut p: *const uint8_t,
                                mut n: libc::c_int,
    ...
    if ret != ARCHIVE_RAR5_DEFINED_PARAM.archive_ok { return ret; }
    num = v as libc::c_int;
    num >>= 16 as libc::c_int - n;
    skip_bits(rar, n);
    if !value.is_null() { *safe_value = num }
    return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok;
}

extern "C" fn read_u32(mut a: *mut archive_read,
                       mut pvalue: *mut uint32_t) -> libc::c_int {
    let mut p: *const uint8_t = 0 as *const uint8_t;
    let safe_pvalue = unsafe { &mut *pvalue };
...
extern "C" fn read_u64(mut a: *mut archive_read,
                       mut pvalue: *mut uint64_t) -> libc::c_int {
    let mut p: *const uint8_t = 0 as *const uint8_t;
    let safe_pvalue = unsafe { &mut *pvalue };
    if read_ahead(a, 8 as libc::c_int as size_t, &mut p) == 0 {
        return 0 as libc::c_int;
...
extern "C" fn bid_standard(mut a: *mut archive_read) -> libc::c_int {
    let mut p: *const uint8_t = 0 as *const uint8_t;
    let mut signature: [libc::c_char; 8] = [0; 8];
    rar5_signature(signature.as_mut_ptr());
    if read_ahead(a,
                  ::std::mem::size_of::<[libc::c_uchar; 8]>() as
                      libc::c_ulong, &mut p) == 0 {
        return -(1 as libc::c_int);
    }
    if memcmp_safe(signature.as_mut_ptr() as *const libc::c_void,
...
extern "C" fn rar5_bid(mut a: *mut archive_read,
                       mut best_bid: libc::c_int) -> libc::c_int {
    let mut my_bid: libc::c_int = 0;
    if best_bid > 30 as libc::c_int { return -(1 as libc::c_int); }
    my_bid = bid_standard(a);
    if my_bid > -(1 as libc::c_int) { return my_bid; }
    return -(1 as libc::c_int);
}

extern "C" fn rar5_options(mut a: *mut archive_read,
...
extern "C" fn init_header(mut a: *mut archive_read) {
...
extern "C" fn init_window_mask(mut rar: *mut rar5) {
    let safe_rar = unsafe { &mut *rar };
    if safe_rar.cstate.window_size != 0 {
        safe_rar.cstate.window_mask =
            (safe_rar.cstate.window_size - 1 as libc::c_int as libc::c_long) as
                size_t
    } else { safe_rar.cstate.window_mask = 0 as libc::c_int as size_t };
}

extern "C" fn process_main_locator_extra_block(mut a:
                                               *mut archive_read,
                                               mut rar: *mut rar5)
                                               -> libc::c_int {
...
extern "C" fn parse_file_extra_hash(mut a: *mut archive_read,
                                    mut rar: *mut rar5,
    ...
    *safe_extra_data_size =
        (*safe_extra_data_size as libc::c_ulong).wrapping_sub(value_len) as ssize_t
            as ssize_t;
    ...
    if hash_type == BLAKE2sp as libc::c_int as libc::c_ulong {
        ...
        let hash_size: libc::c_int =
            ::std::mem::size_of::<[uint8_t; 32]>() as libc::c_ulong as
                libc::c_int;
        if read_ahead(a, hash_size as size_t, &mut p) == 0 {
            return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof;
        }
        safe_rar.file.has_blake2 = 1 as libc::c_int as libc::c_char;
        memcpy_safe(&mut safe_rar.file.blake2sp as *mut [uint8_t; 32] as
                        *mut libc::c_void, p as *const libc::c_void,
        ...
        *safe_extra_data_size -= hash_size as libc::c_long
        ...
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Unsupported hash type (0x%x)\x00" as *const u8 as
                              *const libc::c_char, hash_type as libc::c_int);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok;
}

extern "C" fn time_win_to_unix(mut win_time: uint64_t) -> uint64_t {
...
extern "C" fn parse_htime_item(mut a: *mut archive_read,
    ...
    if unix_time != 0 {
        ...
        if read_u32(a, &mut time_val) == 0 { return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof; }
        *safe_extra_data_size -= 4 as libc::c_int as libc::c_long;
        *safe_where_0 = time_val as uint64_t
    } else {
        let mut windows_time: uint64_t = 0;
        if read_u64(a, &mut windows_time) == 0 { return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof; }
...
extern "C" fn parse_file_extra_version(mut a: *mut archive_read,
    ...
    let safe_extra_data_size = unsafe { &mut *extra_data_size };
    let mut version_string: archive_string =
        archive_string {
            s: 0 as *mut libc::c_char,
            length: 0,
            buffer_length: 0,
        };
    let mut name_utf8_string: archive_string =
        archive_string {
            s: 0 as *mut libc::c_char,
            length: 0,
            buffer_length: 0,
    ...
    *safe_extra_data_size =
	 ...
	 * value of this file. */
    archive_string_sprintf_safe!(&mut version_string as *mut archive_string,
                           b";%zu\x00" as *const u8 as *const libc::c_char,
                           version);
    /* Build the new filename. */
    archive_strcat_safe(&mut name_utf8_string,
                        cur_filename as *const libc::c_void);
    archive_strcat_safe(&mut name_utf8_string,
...
extern "C" fn parse_file_extra_htime(mut a: *mut archive_read,
                                     mut e: *mut archive_entry,
                                     mut rar: *mut rar5,
                                     mut extra_data_size: *mut ssize_t)
                                     -> libc::c_int {
    ...
    *safe_extra_data_size =
    ...
    unix_time =
        (flags & IS_UNIX as libc::c_int as libc::c_ulong) as libc::c_char;
    if flags & HAS_MTIME as libc::c_int as libc::c_ulong != 0 {
        parse_htime_item(a, unix_time, &mut safe_rar.file.e_mtime,
                         extra_data_size);
        archive_entry_set_mtime_safe(e, safe_rar.file.e_mtime as time_t,
                                     0 as libc::c_int as libc::c_long);
    }
    if flags & HAS_CTIME as libc::c_int as libc::c_ulong != 0 {
        parse_htime_item(a, unix_time, &mut safe_rar.file.e_ctime,
                         extra_data_size);
        archive_entry_set_ctime_safe(e, safe_rar.file.e_ctime as time_t,
                                     0 as libc::c_int as libc::c_long);
    }
    if flags & HAS_ATIME as libc::c_int as libc::c_ulong != 0 {
        parse_htime_item(a, unix_time, &mut safe_rar.file.e_atime,
                         extra_data_size);
        archive_entry_set_atime_safe(e, safe_rar.file.e_atime as time_t,
                                     0 as libc::c_int as libc::c_long);
    }
...
extern "C" fn parse_file_extra_redir(mut a: *mut archive_read,
                                     mut e: *mut archive_entry,
                                     mut rar: *mut rar5,
                                     mut extra_data_size: *mut ssize_t)
                                     -> libc::c_int {
    ...
    *safe_extra_data_size =
        (*safe_extra_data_size as libc::c_ulong).wrapping_sub(value_size) as
            ssize_t as ssize_t;
    ...
    *safe_extra_data_size =
        (*safe_extra_data_size as
            libc::c_ulong).wrapping_sub(target_size.wrapping_add(1 as
            libc::c_int
            as
            libc::c_ulong))
            as ssize_t as ssize_t;
    if read_ahead(a, target_size, &mut p) == 0 { return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof; }
    if target_size > (ARCHIVE_RAR5_DEFINED_PARAM.max_name_in_chars - 1 as libc::c_int) as libc::c_ulong
    {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Link target is too long\x00" as *const u8 as
                              *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    if target_size == 0 as libc::c_int as libc::c_ulong {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"No link target specified\x00" as *const u8 as
                              *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    memcpy_safe(target_utf8_buf.as_mut_ptr() as *mut libc::c_void,
                p as *const libc::c_void, target_size);
    ...
    match safe_rar.file.redir_type {
        1 | 2 => {
            ...
            archive_entry_update_symlink_utf8_safe(e,
                                                   target_utf8_buf.as_mut_ptr());
            if safe_rar.file.redir_flags & ARCHIVE_RAR5_DEFINED_PARAM.redir_symlink_is_dir as libc::c_ulong !=
                0 {
                archive_entry_set_symlink_type_safe(e, ARCHIVE_RAR5_DEFINED_PARAM.ae_symlink_type_directory);
            } else { archive_entry_set_symlink_type_safe(e, ARCHIVE_RAR5_DEFINED_PARAM.ae_symlink_type_file); }
        }
        4 => {
            archive_entry_set_filetype_safe(e, ARCHIVE_RAR5_DEFINED_PARAM.ae_ifreg as mode_t);
            archive_entry_update_hardlink_utf8_safe(e,
                                                    target_utf8_buf.as_mut_ptr());
        }
        _ => {}
    }
...
extern "C" fn parse_file_extra_owner(mut a: *mut archive_read,
                                     mut e: *mut archive_entry,
                                     mut extra_data_size: *mut ssize_t)
                                     -> libc::c_int {
    ...
    *safe_extra_data_size =
    ...
    if flags & ARCHIVE_RAR5_DEFINED_PARAM.owner_user_name as libc::c_ulong !=
        ...
        *safe_extra_data_size =
            (*safe_extra_data_size as
                libc::c_ulong).wrapping_sub(name_size.wrapping_add(1 as
                libc::c_int
                as
                libc::c_ulong))
                as ssize_t as ssize_t;
        if read_ahead(a, name_size, &mut p) == 0 { return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof; }
        if name_size >= 256 as libc::c_ulong {
            name_len = (256 - 1 as libc::c_int) as size_t
        } else { name_len = name_size }
        memcpy_safe(namebuf.as_mut_ptr() as *mut libc::c_void,
                    p as *const libc::c_void, name_len);
...
extern "C" fn process_head_file_extra(mut a: *mut archive_read,
                                      mut e: *mut archive_entry,
                                      mut rar: *mut rar5,
    ...
    while extra_data_size > 0 as libc::c_int as libc::c_long {
        ...
        extra_data_size =
            (extra_data_size as libc::c_ulong).wrapping_sub(var_size) as
                ssize_t as ssize_t;
        ...
        match extra_field_id {
            ...
            1 | _ => { current_block_17 = 17703749216436980540; }
        }
...
extern "C" fn process_head_file(mut a: *mut archive_read,
                                mut rar: *mut rar5,
    ...
    if safe_rar.cstate.switch_multivolume() == 0 { reset_file_context(rar); }
    ...
    if block_flags & HFL_DATA as libc::c_int as libc::c_ulong != 0 {
        ...
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"no data found in file/service block\x00" as
                              *const u8 as *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    ...
    if file_flags & UNKNOWN_UNPACKED_SIZE as libc::c_int as libc::c_ulong != 0
    {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_programmer,
                          b"Files with unknown unpacked size are not supported\x00"
                              as *const u8 as *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    safe_rar.file.set_dir((file_flags &
        DIRECTORY as libc::c_int as libc::c_ulong >
    ...
    if file_flags & UTIME as libc::c_int as libc::c_ulong != 0 {
        if read_u32(a, &mut mtime) == 0 { return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof; }
    }
    if file_flags & CRC32 as libc::c_int as libc::c_ulong != 0 {
        if read_u32(a, &mut crc) == 0 { return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof; }
    }
    if read_var_sized(a, &mut compression_info, 0 as *mut size_t) == 0 {
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof;
    }
    c_method =
        (compression_info >> 7 as libc::c_int) as libc::c_int &
            0x7 as libc::c_int;
    c_version =
        (compression_info & 0x3f as libc::c_int as libc::c_ulong) as
            libc::c_int;
    ...
    if safe_rar.file.solid() as libc::c_int > 0 as libc::c_int &&
        ...
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Declared solid file, but no window buffer initialized yet.\x00"
                              as *const u8 as *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    ...
    if window_size >
        (64 as libc::c_int * 1024 as libc::c_int * 1024 as libc::c_int) as
            libc::c_ulong ||
        safe_rar.file.dir() as libc::c_int == 0 as libc::c_int &&
            window_size == 0 as libc::c_int as libc::c_ulong {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Declared dictionary size is not supported.\x00" as
                              *const u8 as *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    if safe_rar.file.solid() as libc::c_int > 0 as libc::c_int {
    ...
    if host_os == HOST_WINDOWS as libc::c_int as libc::c_ulong {
        ...
        if file_attr & ATTR_DIRECTORY as libc::c_int as libc::c_ulong != 0 {
            ...
            {
                mode =
                    0o555 as libc::c_int as libc::c_uint |
                        ARCHIVE_RAR5_DEFINED_PARAM.ae_ifdir as mode_t
            } else {
                mode =
                    0o755 as libc::c_int as libc::c_uint |
                        ARCHIVE_RAR5_DEFINED_PARAM.ae_ifdir as mode_t
            }
        } else if file_attr & ATTR_READONLY as libc::c_int as libc::c_ulong !=
            0 {
            mode =
                0o444 as libc::c_int as libc::c_uint |
                    ARCHIVE_RAR5_DEFINED_PARAM.ae_ifreg as mode_t
        } else {
            mode =
                0o644 as libc::c_int as libc::c_uint |
                    ARCHIVE_RAR5_DEFINED_PARAM.ae_ifreg as mode_t
        }
        archive_entry_set_mode_safe(entry, mode);
        if file_attr &
            (ATTR_READONLY as libc::c_int | ATTR_HIDDEN as libc::c_int |
                ATTR_SYSTEM as libc::c_int) as libc::c_ulong != 0 {
            let mut fflags_text: *mut libc::c_char = 0 as *mut libc::c_char;
            let mut ptr: *mut libc::c_char = 0 as *mut libc::c_char;
            /* allocate for "rdonly,hidden,system," */
            fflags_text =
                malloc_safe((22 as libc::c_int as
                    libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_char>()
                    as libc::c_ulong))
                    as *mut libc::c_char;
            if !fflags_text.is_null() {
                ptr = fflags_text;
                if file_attr & ATTR_READONLY as libc::c_int as libc::c_ulong
                    != 0 {
                    strcpy_safe(ptr,
                                b"rdonly,\x00" as *const u8 as
                                    *const libc::c_char);
                    unsafe { ptr = ptr.offset(7 as libc::c_int as isize) }
                }
                if file_attr & ATTR_HIDDEN as libc::c_int as libc::c_ulong !=
                    0 {
                    strcpy_safe(ptr,
                ...
                if file_attr & ATTR_SYSTEM as libc::c_int as libc::c_ulong !=
                    0 {
                    strcpy_safe(ptr,
        ...
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Unsupported Host OS: 0x%x\x00" as *const u8 as
                              *const libc::c_char, host_os as libc::c_int);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    if read_var_sized(a, &mut name_size, 0 as *mut size_t) == 0 {
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof;
    ...
    if read_ahead(a, name_size, &mut p) == 0 { return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof; }
    if name_size > (ARCHIVE_RAR5_DEFINED_PARAM.max_name_in_chars - 1 as libc::c_int) as libc::c_ulong {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Filename is too long\x00" as *const u8 as
                              *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    if name_size == 0 as libc::c_int as libc::c_ulong {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"No filename specified\x00" as *const u8 as
                              *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    memcpy_safe(name_utf8_buf.as_mut_ptr() as *mut libc::c_void,
                p as *const libc::c_void, name_size);
    ...
    if extra_data_size > 0 as libc::c_int as libc::c_long {
        let mut ret: libc::c_int =
            process_head_file_extra(a, entry, rar, extra_data_size);
        /*
    ...
    if file_flags & UNKNOWN_UNPACKED_SIZE as libc::c_int as libc::c_ulong ==
        ...
        if safe_rar.file.redir_type ==
            REDIR_TYPE_NONE as libc::c_int as libc::c_ulong {
            archive_entry_set_size_safe(entry, unpacked_size as la_int64_t);
        }
    }
    if file_flags & UTIME as libc::c_int as libc::c_ulong != 0 {
        archive_entry_set_mtime_safe(entry, mtime as time_t,
                                     0 as libc::c_int as libc::c_long);
    }
    if file_flags & CRC32 as libc::c_int as libc::c_ulong != 0 {
    ...
    if safe_rar.cstate.switch_multivolume() == 0 {
		 ...
		 * archives. */
        safe_rar.cstate.set_block_parsing_finished(1 as libc::c_int as uint8_t);
        safe_rar.cstate.set_all_filters_applied(1 as libc::c_int as uint8_t);
    ...
    if safe_rar.generic.split_before() as libc::c_int > 0 as libc::c_int {
		 ...
		 * again. */
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_retry;
    } else { return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok; };
}

extern "C" fn process_head_service(mut a: *mut archive_read,
                                   mut rar: *mut rar5,
                                   mut entry: *mut archive_entry,
                                   mut block_flags: size_t)
                                   -> libc::c_int {
...
extern "C" fn process_head_main(mut a: *mut archive_read,
                                mut rar: *mut rar5,
                                mut entry: *mut archive_entry,
                                mut block_flags: size_t)
                                -> libc::c_int {
    ...
    } else { extra_data_size = 0 as libc::c_int as size_t }
    if read_var_sized(a, &mut archive_flags, 0 as *mut size_t) == 0 {
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof;
    }
    safe_rar.main.set_volume((archive_flags &
        VOLUME as libc::c_int as libc::c_ulong >
        0 as libc::c_int as libc::c_ulong) as
        libc::c_int as uint8_t);
    safe_rar.main.set_solid((archive_flags &
        SOLID_0 as libc::c_int as libc::c_ulong >
        0 as libc::c_int as libc::c_ulong) as
        libc::c_int as uint8_t);
    if archive_flags & VOLUME_NUMBER as libc::c_int as libc::c_ulong != 0 {
        ...
        if v > ARCHIVE_RAR5_DEFINED_PARAM.uint_max as libc::c_ulong {
            archive_set_error_safe!(&mut (*a).archive as *mut archive,
                              ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                              b"Invalid volume number\x00" as *const u8 as
                                  *const libc::c_char);
            return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
        }
        safe_rar.main.vol_no = v as libc::c_uint
    } else { safe_rar.main.vol_no = 0 as libc::c_int as libc::c_uint }
    ...
    if extra_field_size == 0 as libc::c_int as libc::c_ulong {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Invalid extra field size\x00" as *const u8 as
                              *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    match extra_field_id {
        ...
        _ => {
            archive_set_error_safe!(&mut (*a).archive as *mut archive,
                              ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                              b"Unsupported extra type (0x%x)\x00" as
                                  *const u8 as *const libc::c_char,
...
extern "C" fn skip_unprocessed_bytes(mut a: *mut archive_read)
                                     -> libc::c_int {
    let mut rar: *mut rar5 = get_context(a);
    let mut ret: libc::c_int = 0;
    let safe_rar = unsafe { &mut *rar };
 ...
 * <FILE> block.
 */
extern "C" fn process_base_block(mut a: *mut archive_read,
                                 mut entry: *mut archive_entry)
                                 -> libc::c_int {
    ...
    if read_u32(a, &mut hdr_crc) == 0 { return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof; }
    /* Read header size. */
    ...
    if raw_hdr_size == 0 as libc::c_int as libc::c_ulong ||
        ...
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Too small block encountered (%zu bytes)\x00" as
                              *const u8 as *const libc::c_char, raw_hdr_size);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    /* Read the whole header data into memory, maximum memory use here is
	 * 2MB. */
    if read_ahead(a, hdr_size, &mut p) == 0 { return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof; }
    /* Verify the CRC32 of the header data. */
    computed_crc =
        crc32_safe(0 as libc::c_int as uLong, p, hdr_size as libc::c_int as uInt)
            as uint32_t;
    if computed_crc != hdr_crc {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Header CRC error\x00" as *const u8 as
                              *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    ...
    safe_rar.generic.set_split_after((header_flags &
        HFL_SPLIT_AFTER as libc::c_int as
            libc::c_ulong >
        0 as libc::c_int as libc::c_ulong) as
        libc::c_int as uint8_t);
    safe_rar.generic.set_split_before((header_flags &
        HFL_SPLIT_BEFORE as libc::c_int as
            libc::c_ulong >
        0 as libc::c_int as libc::c_ulong) as
        libc::c_int as uint8_t);
    ...
    match header_id {
        1 => {
            ...
            if ret == ARCHIVE_RAR5_DEFINED_PARAM.archive_ok { return ARCHIVE_RAR5_DEFINED_PARAM.archive_retry; }
            return ret;
        }
        3 => {
        ...
        5 => {
            ...
            if safe_rar.main.volume() != 0 {
                ...
                if ret == ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal {
                    ...
                    if safe_rar.vol.expected_vol_no == ARCHIVE_RAR5_DEFINED_PARAM.uint_max as libc::c_uint
                    {
                        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                                          b"Header error\x00" as *const u8 as
                                              *const libc::c_char);
                        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
                    }
                    safe_rar.vol.expected_vol_no =
                        safe_rar.main.vol_no.wrapping_add(1 as libc::c_int as
                            libc::c_uint);
                    return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok;
                }
            } else { return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof; }
        }
        0 => { return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof; }
        _ => {
            if header_flags &
                HFL_SKIP_IF_UNKNOWN as libc::c_int as libc::c_ulong ==
                0 as libc::c_int as libc::c_ulong {
                archive_set_error_safe!(&mut (*a).archive as *mut archive,
                                  ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                                  b"Header type error\x00" as *const u8 as
                                      *const libc::c_char);
                return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
            } else {
...
extern "C" fn skip_base_block(mut a: *mut archive_read)
                              -> libc::c_int {
    let mut ret: libc::c_int = 0;
    let mut rar: *mut rar5 = get_context(a);
    let safe_rar = unsafe { &mut *rar };
    ...
    if ret == ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal { return ret; }
...
extern "C" fn rar5_read_header(mut a: *mut archive_read,
                               mut entry: *mut archive_entry)
                               -> libc::c_int {
    let mut rar: *mut rar5 = get_context(a);
    let mut ret: libc::c_int = 0;
...
extern "C" fn init_unpack(mut rar: *mut rar5) {
    let safe_rar = unsafe { &mut *rar };
    ...
    if safe_rar.cstate.window_size > 0 as libc::c_int as libc::c_long {
        safe_rar.cstate.window_buf =
            calloc_safe(1 as libc::c_int as libc::c_ulong,
                        safe_rar.cstate.window_size as libc::c_ulong) as
                *mut uint8_t;
        safe_rar.cstate.filtered_buf =
            calloc_safe(1 as libc::c_int as libc::c_ulong,
                        safe_rar.cstate.window_size as libc::c_ulong) as *mut uint8_t
    } else {
    ...
    safe_rar.cstate.write_ptr = 0 as libc::c_int as int64_t;
    safe_rar.cstate.last_write_ptr = 0 as libc::c_int as int64_t;
    memset_safe(&mut safe_rar.cstate.bd as *mut decode_table as *mut libc::c_void,
                0 as libc::c_int,
                ::std::mem::size_of::<decode_table>() as libc::c_ulong);
    memset_safe(&mut safe_rar.cstate.ld as *mut decode_table as *mut libc::c_void,
                0 as libc::c_int,
                ::std::mem::size_of::<decode_table>() as libc::c_ulong);
    memset_safe(&mut safe_rar.cstate.dd as *mut decode_table as *mut libc::c_void,
                0 as libc::c_int,
                ::std::mem::size_of::<decode_table>() as libc::c_ulong);
    memset_safe(&mut safe_rar.cstate.ldd as *mut decode_table as *mut libc::c_void,
                0 as libc::c_int,
                ::std::mem::size_of::<decode_table>() as libc::c_ulong);
    memset_safe(&mut safe_rar.cstate.rd as *mut decode_table as *mut libc::c_void,
                0 as libc::c_int,
                ::std::mem::size_of::<decode_table>() as libc::c_ulong);
}

extern "C" fn update_crc(mut rar: *mut rar5, mut p: *const uint8_t,
                         mut to_read: size_t) {
    let mut verify_crc: libc::c_int = 0;
    let safe_rar = unsafe { &mut *rar };
    if safe_rar.skip_mode != 0 {
        match () {
            #[cfg(CHECK_CRC_ON_SOLID_SKIP)] _ => {
                verify_crc = 1 as libc::c_int;
            }
            #[cfg(not(CHECK_CRC_ON_SOLID_SKIP))] _ => {
                verify_crc = 0 as libc::c_int
            }
        }
    } else { verify_crc = 1 as libc::c_int }
    if verify_crc != 0 {
        ...
        if safe_rar.file.stored_crc32 > 0 as libc::c_int as libc::c_uint {
            safe_rar.file.calculated_crc32 =
                crc32_safe(safe_rar.file.calculated_crc32 as uLong, p,
                           to_read as uInt) as uint32_t
        }
...
extern "C" fn create_decode_tables(mut bit_length: *mut uint8_t,
    ...
    memset_safe(&mut lc as *mut [libc::c_int; 16] as *mut libc::c_void,
                0 as libc::c_int,
                ::std::mem::size_of::<[libc::c_int; 16]>() as libc::c_ulong);
    memset_safe(safe_table.decode_num.as_mut_ptr() as *mut libc::c_void,
                0 as libc::c_int,
                ::std::mem::size_of::<[uint16_t; 306]>() as libc::c_ulong);
    safe_table.size = size as uint32_t;
    safe_table.quick_bits =
        if size == ARCHIVE_RAR5_DEFINED_PARAM.huff_nc {
            10 as libc::c_int
        } else { 7 as libc::c_int } as uint32_t;
    i = 0 as libc::c_int;
    while i < size {
        unsafe {
            lc[(*bit_length.offset(i as isize) as libc::c_int & 15 as libc::c_int)
                as usize] += 1
        };
        i += 1
    }
    lc[0 as libc::c_int as usize] = 0 as libc::c_int;
    safe_table.decode_pos[0 as libc::c_int as usize] =
        0 as libc::c_int as uint32_t;
    safe_table.decode_len[0 as libc::c_int as usize] = 0 as libc::c_int;
    i = 1 as libc::c_int;
    while i < 16 as libc::c_int {
        upper_limit += lc[i as usize];
        safe_table.decode_len[i as usize] =
            upper_limit << 16 as libc::c_int - i;
        safe_table.decode_pos[i as usize] =
            safe_table.decode_pos[(i - 1 as libc::c_int) as
                usize].wrapping_add(lc[(i -
                1 as
                    libc::c_int)
                as usize] as
                libc::c_uint);
    ...
    memcpy_safe(decode_pos_clone.as_mut_ptr() as *mut libc::c_void,
    ...
    while i < size {
        let mut clen: uint8_t =
            unsafe {
                (*bit_length.offset(i as isize) as libc::c_int &
                    15 as libc::c_int) as uint8_t
            };
        if clen as libc::c_int > 0 as libc::c_int {
            let mut last_pos: libc::c_int =
                decode_pos_clone[clen as usize] as libc::c_int;
            safe_table.decode_num[last_pos as usize] = i as uint16_t;
            decode_pos_clone[clen as usize] =
                decode_pos_clone[clen as usize].wrapping_add(1)
        }
        i += 1
    }
    ...
    while (code as libc::c_long) < quick_data_size {
        let mut bit_field: libc::c_int =
            code <<
                (16 as libc::c_int as
                    libc::c_uint).wrapping_sub(safe_table.quick_bits);
        let mut dist: libc::c_int = 0;
        let mut pos: libc::c_int = 0;
        while cur_len <
            (::std::mem::size_of::<[int32_t; 16]>() as
        ...
        dist =
            bit_field -
                safe_table.decode_len[(cur_len -
                    1 as libc::c_int as libc::c_long) as
                    usize];
        dist >>= 16 as libc::c_int as libc::c_long - cur_len;
        pos =
            safe_table.decode_pos[(cur_len & 15 as libc::c_int as libc::c_long)
                as
                usize].wrapping_add(dist as libc::c_uint)
                as libc::c_int;
        if cur_len <
            (::std::mem::size_of::<[uint32_t; 16]>() as
                libc::c_ulong).wrapping_div(::std::mem::size_of::<uint32_t>()
                as libc::c_ulong) as
                ssize_t && pos < size {
            safe_table.quick_num[code as usize] =
                safe_table.decode_num[pos as usize]
        } else {
...
extern "C" fn decode_number(mut a: *mut archive_read,
                            mut table: *mut decode_table,
                            mut p: *const uint8_t,
                            mut num: *mut uint16_t) -> libc::c_int {
    let mut i: libc::c_int = 0;
    ...
    if (bitfield as libc::c_int) <
        safe_table.decode_len[safe_table.quick_bits as usize] {
        let mut code: libc::c_int =
            bitfield as libc::c_int >>
                (16 as libc::c_int as
                    libc::c_uint).wrapping_sub(safe_table.quick_bits);
    ...
    i =
        safe_table.quick_bits.wrapping_add(1 as libc::c_int as libc::c_uint) as
            libc::c_int;
    ...
    dist =
        bitfield as libc::c_int -
            safe_table.decode_len[(bits - 1 as libc::c_int) as usize];
    dist >>= 16 as libc::c_int - bits;
    pos =
        safe_table.decode_pos[bits as usize].wrapping_add(dist as libc::c_uint);
    if pos >= safe_table.size { pos = 0 as libc::c_int as uint32_t }
    *safe_num = safe_table.decode_num[pos as usize];
    return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok;
}
/* Reads and parses Huffman tables from the beginning of the block. */
extern "C" fn parse_tables(mut a: *mut archive_read,
                           mut rar: *mut rar5, mut p: *const uint8_t)
                           -> libc::c_int {
    let mut ret: libc::c_int = 0;
    ...
    while w < ARCHIVE_RAR5_DEFINED_PARAM.huff_bc {
        if i as libc::c_long >= safe_rar.cstate.cur_block_size {
            ...
            archive_set_error_safe!(&mut (*a).archive as *mut archive,
                              ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                              b"Truncated data in huffman tables\x00" as
                                  *const u8 as *const libc::c_char);
            return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
        }
        value =
            unsafe {
                (*p.offset(i as isize) as libc::c_int &
                    nibble_mask as libc::c_int) >> nibble_shift as libc::c_int
            };
        if nibble_mask as libc::c_int == 0xf as libc::c_int { i += 1 }
        nibble_mask =
            (nibble_mask as libc::c_int ^ 0xff as libc::c_int) as uint8_t;
        nibble_shift =
            (nibble_shift as libc::c_int ^ 4 as libc::c_int) as uint8_t;
    ...
    safe_rar.bits.bit_addr =
        (nibble_shift as libc::c_int ^ 4 as libc::c_int) as int8_t;
    ret =
        create_decode_tables(bit_length.as_mut_ptr(), &mut safe_rar.cstate.bd, ARCHIVE_RAR5_DEFINED_PARAM.huff_bc);
    if ret != ARCHIVE_RAR5_DEFINED_PARAM.archive_ok {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
    ...
    while i < ARCHIVE_RAR5_DEFINED_PARAM.huff_table_size {
        ...
        if (safe_rar.bits.in_addr + 6 as libc::c_int) as libc::c_long >=
            ...
            archive_set_error_safe!(&mut (*a).archive as *mut archive,
                              ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                              b"Truncated data in huffman tables (#2)\x00" as
                                  *const u8 as *const libc::c_char);
            return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
        }
        ...
        if ret != ARCHIVE_RAR5_DEFINED_PARAM.archive_ok {
            archive_set_error_safe!(&mut (*a).archive as *mut archive,
                              ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                              b"Decoding huffman tables failed\x00" as
                                  *const u8 as *const libc::c_char);
            return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
        }
        if (num as libc::c_int) < 16 as libc::c_int {
            ...
            if i > 0 as libc::c_int {
                loop {
                    ...
                    table[i as usize] =
                        table[(i - 1 as libc::c_int) as usize];
                    i += 1
                }
            } else {
                archive_set_error_safe!(&mut (*a).archive as *mut archive,
                                  ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                                  b"Unexpected error when decoding huffman tables\x00"
                                      as *const u8 as *const libc::c_char);
                return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
            }
        } else {
    ...
    ret =
        create_decode_tables(unsafe { &mut *table.as_mut_ptr().offset(idx as isize) },
                             &mut safe_rar.cstate.ld, ARCHIVE_RAR5_DEFINED_PARAM.huff_nc);
    if ret != ARCHIVE_RAR5_DEFINED_PARAM.archive_ok {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
    ...
    ret =
        create_decode_tables(unsafe { &mut *table.as_mut_ptr().offset(idx as isize) },
                             &mut safe_rar.cstate.dd, ARCHIVE_RAR5_DEFINED_PARAM.huff_dc);
    if ret != ARCHIVE_RAR5_DEFINED_PARAM.archive_ok {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
    ...
    ret =
        create_decode_tables(unsafe { &mut *table.as_mut_ptr().offset(idx as isize) },
                             &mut safe_rar.cstate.ldd, ARCHIVE_RAR5_DEFINED_PARAM.huff_ldc);
    if ret != ARCHIVE_RAR5_DEFINED_PARAM.archive_ok {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Failed to create lower bits of distances table\x00"
                              as *const u8 as *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    ...
    ret =
        create_decode_tables(unsafe { &mut *table.as_mut_ptr().offset(idx as isize) },
                             &mut safe_rar.cstate.rd, ARCHIVE_RAR5_DEFINED_PARAM.huff_rc);
    if ret != ARCHIVE_RAR5_DEFINED_PARAM.archive_ok {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Failed to create repeating distances table\x00" as
                              *const u8 as *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok;
...
extern "C" fn parse_block_header(mut a: *mut archive_read,
                                 mut p: *const uint8_t,
    ...
    memcpy_safe(hdr as *mut libc::c_void, p as *const libc::c_void,
                ::std::mem::size_of::<compressed_block_header>() as libc::c_ulong);
    if bf_byte_count(hdr) as libc::c_int > 2 as libc::c_int {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Unsupported block header size (was %d, max is 2)\x00"
                              as *const u8 as *const libc::c_char,
    ...
    *safe_block_size = 0 as libc::c_int as ssize_t;
    match bf_byte_count(hdr) as libc::c_int {
        0 => {
            ...
            *safe_block_size =
                unsafe {
                    *(&*p.offset(2 as libc::c_int as isize) as *const uint8_t) as
                        ssize_t
                }
        }
        1 => {
            ...
            *safe_block_size =
                unsafe {
                    archive_le16dec(&*p.offset(2 as libc::c_int as isize) as
                        *const uint8_t as *const libc::c_void) as
                        ssize_t
                }
        }
        2 => {
            ...
            *safe_block_size =
                unsafe {
                    archive_le32dec(&*p.offset(2 as libc::c_int as isize) as
                        *const uint8_t as *const libc::c_void) as
                        ssize_t
                };
	 ...
	 * always * constant. */
    calculated_cksum =
        (0x5a as libc::c_int ^ safe_hdr.block_flags_u8 as libc::c_int ^
            *safe_block_size as uint8_t as libc::c_int ^
            (*safe_block_size >> 8 as libc::c_int) as uint8_t as libc::c_int ^
            (*safe_block_size >> 16 as libc::c_int) as uint8_t as libc::c_int) as
            uint8_t;
    if calculated_cksum as libc::c_int != safe_hdr.block_cksum as libc::c_int {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Block checksum error: got 0x%x, expected 0x%x\x00"
                              as *const u8 as *const libc::c_char,
...
extern "C" fn parse_filter_data(mut rar: *mut rar5,
                                mut p: *const uint8_t,
    ...
    while i < bytes {
        ...
        data =
            (data as
                libc::c_uint).wrapping_add((byte as uint32_t >>
                8 as libc::c_int) <<
                i * 8 as libc::c_int) as
...
extern "C" fn is_valid_filter_block_start(mut rar: *mut rar5,
                                          mut start: uint32_t)
                                          -> libc::c_int {
    let safe_rar = unsafe { &mut *rar };
    ...
    if last_bs == 0 as libc::c_int as libc::c_long ||
        last_bl == 0 as libc::c_int as libc::c_long {
...
extern "C" fn parse_filter(mut ar: *mut archive_read,
                           mut p: *const uint8_t) -> libc::c_int {
    ...
    filter_type =
        (filter_type as libc::c_int >> 13 as libc::c_int) as uint16_t;
    skip_bits(rar, 3 as libc::c_int);
    ...
    if block_length < 4 as libc::c_int as libc::c_uint ||
        ...
        archive_set_error_safe!(&mut (*ar).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Invalid filter encountered\x00" as *const u8 as
                              *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    ...
    if filt.is_null() {
        archive_set_error_safe!(&mut (*ar).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.enomem,
                          b"Can\'t allocate memory for a filter descriptor.\x00"
                              as *const u8 as *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    unsafe {
        ...
        (*filt).block_start =
            safe_rar.cstate.write_ptr + block_start as libc::c_long;
...
extern "C" fn decode_code_length(mut rar: *mut rar5,
                                 mut p: *const uint8_t,
                                 mut code: uint16_t) -> libc::c_int {
    ...
    if (code as libc::c_int) < 8 as libc::c_int {
        ...
        length +=
            (4 as libc::c_int | code as libc::c_int & 3 as libc::c_int) <<
                lbits
    }
...
extern "C" fn copy_string(mut a: *mut archive_read,
                          mut len: libc::c_int, mut dist: libc::c_int)
                          -> libc::c_int {
    let mut rar: *mut rar5 = get_context(a);
    let safe_rar = unsafe { &mut *rar };
    ...
    let mut i: libc::c_int = 0;
    if safe_rar.cstate.window_buf.is_null() { return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal; }
    ...
    i = 0 as libc::c_int;
    while i < len {
        let write_idx: ssize_t =
            (write_ptr.wrapping_add(i as libc::c_ulong) & cmask) as ssize_t;
        let read_idx: ssize_t =
            (write_ptr.wrapping_add(i as
                libc::c_ulong).wrapping_sub(dist as
                libc::c_ulong)
                & cmask) as ssize_t;
        unsafe {
...
extern "C" fn do_uncompress_block(mut a: *mut archive_read,
                                  mut p: *const uint8_t)
                                  -> libc::c_int {
    let mut rar: *mut rar5 = get_context(a);
    let mut num: uint16_t = 0;
    ...
    let bit_size: uint8_t =
        (1 as libc::c_int + bf_bit_size(hdr) as libc::c_int) as uint8_t;
    while !(safe_rar.cstate.write_ptr - safe_rar.cstate.last_write_ptr >
        ...
        if safe_rar.bits.in_addr as libc::c_long >
            ...
            safe_rar.bits.in_addr as libc::c_long ==
                ...
                safe_rar.bits.bit_addr as libc::c_int >=
                    bit_size as libc::c_int {
            /* If the program counter is here, it means the
			 * function has finished processing the block. */
            safe_rar.cstate.set_block_parsing_finished(1 as libc::c_int as
                uint8_t);
            break;
        } else {
		 ...
		 */
            if (num as libc::c_int) < 256 as libc::c_int {
                ...
                let mut write_idx: int64_t =
                    safe_rar.cstate.solid_offset + fresh7;
                unsafe {
                    *(*rar).cstate.window_buf.offset((write_idx as libc::c_ulong &
                        cmask) as isize) =
                        num as uint8_t
                }
                ...
                if len == -(1 as libc::c_int) {
                    archive_set_error_safe!(&mut (*a).archive as *mut archive,
                                      ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_programmer,
                                      b"Failed to decode the code length\x00"
                                          as *const u8 as
                                          *const libc::c_char);
                    return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
                }
                if ARCHIVE_RAR5_DEFINED_PARAM.archive_ok !=
                    decode_number(a, &mut safe_rar.cstate.dd, p,
                                  &mut dist_slot) {
                    archive_set_error_safe!(&mut (*a).archive as *mut archive,
                                      ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_programmer,
                                      b"Failed to decode the distance slot\x00"
                                          as *const u8 as
                                          *const libc::c_char);
                    return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
                }
                if (dist_slot as libc::c_int) < 4 as libc::c_int {
                    ...
                    dbits =
                        dist_slot as libc::c_int / 2 as libc::c_int -
                            1 as libc::c_int;
                ...
                if dbits > 0 as libc::c_int {
                    if dbits >= 4 as libc::c_int {
                        ...
                        if dbits > 4 as libc::c_int {
                            ...
                            add =
                                add >> 36 as libc::c_int - dbits <<
                                    4 as libc::c_int;
                            dist =
                                (dist as libc::c_uint).wrapping_add(add) as
                                    libc::c_int as libc::c_int
                        }
                        if ARCHIVE_RAR5_DEFINED_PARAM.archive_ok !=
                            decode_number(a, &mut safe_rar.cstate.ldd, p,
                                          &mut low_dist) {
                            archive_set_error_safe!(&mut (*a).archive as
                                                  *mut archive,
                                              ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_programmer,
                                              b"Failed to decode the distance slot\x00"
                                                  as *const u8 as
                        ...
                        if dist >=
                            ARCHIVE_RAR5_DEFINED_PARAM.int_max -
                                low_dist as libc::c_int - 1 as libc::c_int
                        {
						 ...
						 * invalid archives. */
                            archive_set_error_safe!(&mut (*a).archive as
                                                  *mut archive,
                                              ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                                              b"Distance pointer overflow\x00"
                                                  as *const u8 as
                                                  *const libc::c_char);
                            return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
                        }
                ...
                if dist > 0x100 as libc::c_int {
                    ...
                    if dist > 0x2000 as libc::c_int {
                        len += 1;
                        if dist > 0x40000 as libc::c_int { len += 1 }
                    }
                }
                ...
                if safe_rar.cstate.last_len != 0 as libc::c_int {
                    if ARCHIVE_RAR5_DEFINED_PARAM.archive_ok !=
                        copy_string(a, safe_rar.cstate.last_len,
                                    safe_rar.cstate.dist_cache[0 as
                                        libc::c_int
                                        as usize])
                    {
                        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
...
extern "C" fn scan_for_signature(mut a: *mut archive_read)
                                 -> libc::c_int {
    let mut p: *const uint8_t = 0 as *const uint8_t;
    ...
    loop {
        ...
        while i <
            (chunk_size -
                ::std::mem::size_of::<[libc::c_uchar; 8]>() as
                    libc::c_ulong as libc::c_int) as libc::c_long {
            if memcmp_safe(unsafe {
                &*p.offset(i as isize) as *const uint8_t as
                    *const libc::c_void
            },
                ...
                consume(a,
                        (i as
                            libc::c_ulong).wrapping_add(::std::mem::size_of::<[libc::c_uchar; 8]>()
                            as libc::c_ulong)
                            as int64_t);
                return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok;
            }
...
extern "C" fn advance_multivolume(mut a: *mut archive_read)
                                  -> libc::c_int {
...
*/
    {
        if safe_rar.main.endarc() as libc::c_int == 1 as libc::c_int {
            ...
            while looping != 0 {
                ...
                if lret == ARCHIVE_RAR5_DEFINED_PARAM.archive_retry {} else if lret == ARCHIVE_RAR5_DEFINED_PARAM.archive_ok {
                    /* Break loop. */
			 ...
			 * the results. */
            lret = skip_base_block(a);
            if lret == ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal || lret == ARCHIVE_RAR5_DEFINED_PARAM.archive_failed {
                return lret;
            }
			 ...
			 * a base FILE block. */
            if !(lret != ARCHIVE_RAR5_DEFINED_PARAM.archive_retry) { continue; }
...
extern "C" fn merge_block(mut a: *mut archive_read,
                          mut block_size: ssize_t,
                          mut p: *mut *const uint8_t) -> libc::c_int {
    let mut rar: *mut rar5 = get_context(a);
    ...
    safe_rar.cstate.set_switch_multivolume(1 as libc::c_int as uint8_t);
    ...
    safe_rar.vol.push_buf =
        malloc_safe((block_size + 8 as libc::c_int as libc::c_long) as
            libc::c_ulong) as *mut uint8_t;
    if safe_rar.vol.push_buf.is_null() {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.enomem,
                          b"Can\'t allocate memory for a merge block buffer.\x00"
                              as *const u8 as *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    ...
    memset_safe(unsafe {
        &mut *(*rar).vol.push_buf.offset(block_size as isize) as
...
* archive files until the whole block is read. */
    ...
    * archive file and read it. */
    {
        cur_block_size =
            if safe_rar.file.bytes_remaining > block_size - partial_offset {
                (block_size) - partial_offset
            } else { safe_rar.file.bytes_remaining };
        if cur_block_size == 0 as libc::c_int as libc::c_long {
            archive_set_error_safe!(&mut (*a).archive as *mut archive,
                              ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                              b"Encountered block size == 0 during block merge\x00"
                                  as *const u8 as *const libc::c_char);
            return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
        }
        ...
        if partial_offset + cur_block_size > block_size {
            archive_set_error_safe!(&mut (*a).archive as *mut archive,
                              ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_programmer,
                              b"Consumed too much data when merging blocks.\x00"
                                  as *const u8 as *const libc::c_char);
            return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
        }
		 ...
		 * iteration. */
        memcpy_safe(unsafe {
            &mut *(*rar).vol.push_buf.offset(partial_offset as isize) as
                *mut uint8_t as *mut libc::c_void
        },
                    lp as *const libc::c_void, cur_block_size as libc::c_ulong);
		 ...
		 * block. */
        if partial_offset == block_size { break; }
...
extern "C" fn process_block(mut a: *mut archive_read) -> libc::c_int {
    let mut p: *const uint8_t = 0 as *const uint8_t;
    let mut rar: *mut rar5 = get_context(a);
    let mut ret: libc::c_int = 0;
    let safe_rar = unsafe { &mut *rar };
    ...
    if safe_rar.cstate.block_parsing_finished() != 0 {
        ...
        ret =
            parse_block_header(a, p, &mut block_size,
                               &mut safe_rar.last_block_hdr);
        if ret != ARCHIVE_RAR5_DEFINED_PARAM.archive_ok { return ret; }
        /* Skip block header. Next data is huffman tables,
		 * if present. */
        to_skip =
            (::std::mem::size_of::<compressed_block_header>() as
                libc::c_ulong).wrapping_add(bf_byte_count(&mut safe_rar.last_block_hdr)
                as
                ...
                libc::c_ulong)
                as ssize_t;
        if ARCHIVE_RAR5_DEFINED_PARAM.archive_ok != consume(a, to_skip) { return ARCHIVE_RAR5_DEFINED_PARAM.archive_eof; }
        ...
        cur_block_size =
            if safe_rar.file.bytes_remaining > block_size {
                block_size
            } else { safe_rar.file.bytes_remaining };
        if block_size > safe_rar.file.bytes_remaining {
            ...
            safe_rar.cstate.set_switch_multivolume(0 as libc::c_int as uint8_t);
			 ...
			 * chunk of 4kb's. */
            if read_ahead(a,
                          (4 as libc::c_int as libc::c_long + cur_block_size)
                              as size_t, &mut p) == 0 {
        ...
        safe_rar.cstate.set_block_parsing_finished(0 as libc::c_int as uint8_t);
    ...
    if safe_rar.cstate.block_parsing_finished() as libc::c_int != 0 &&
        safe_rar.cstate.switch_multivolume() as libc::c_int ==
            0 as libc::c_int &&
...
extern "C" fn use_data(mut rar: *mut rar5,
                       mut buf: *mut *const libc::c_void,
                       mut size: *mut size_t, mut offset: *mut int64_t)
                       -> libc::c_int {
    let mut i: libc::c_int = 0;
    ...
    while (i as libc::c_long) <
        (::std::mem::size_of::<[data_ready; 2]>() as
            libc::c_ulong).wrapping_div(::std::mem::size_of::<data_ready>()
            as libc::c_ulong) as
            ssize_t {
        let mut d: *mut data_ready =
            unsafe {
                &mut *(*rar).cstate.dready.as_mut_ptr().offset(i as isize) as
                    *mut data_ready
            };
        let safe_d = unsafe { &mut *d };
        if safe_d.used != 0 {
            if !buf.is_null() { *safe_buf = safe_d.buf as *const libc::c_void }
            if !size.is_null() { *safe_size = safe_d.size }
            if !offset.is_null() { *safe_offset = safe_d.offset }
 ...
 * function. */
extern "C" fn push_data_ready(mut a: *mut archive_read,
                              mut rar: *mut rar5,
                              mut buf: *const uint8_t,
                              mut size: size_t, mut offset: int64_t)
                              -> libc::c_int {
    let mut i: libc::c_int = 0;
    let safe_rar = unsafe { &mut *rar };
    ...
    if safe_rar.skip_mode != 0 { return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok; }
    /* Sanity check. */
    if offset != safe_rar.file.last_offset + safe_rar.file.last_size {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_programmer,
                          b"Sanity check error: output stream is not continuous\x00"
                              as *const u8 as *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    i = 0 as libc::c_int;
    ...
    archive_set_error_safe!(&mut (*a).archive as *mut archive, ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_programmer,
                      b"Error: premature end of data_ready stack\x00" as
                          *const u8 as *const libc::c_char);
    return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
}
 ...
 * */
extern "C" fn do_uncompress_file(mut a: *mut archive_read)
                                 -> libc::c_int {
    let mut rar: *mut rar5 = get_context(a);
    let mut ret: libc::c_int = 0;
    ...
    * files). */
        {
            ret = process_block(a);
            if ret == ARCHIVE_RAR5_DEFINED_PARAM.archive_eof || ret == ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal {
                return ret;
            }
    ...
    if ret == ARCHIVE_RAR5_DEFINED_PARAM.archive_retry {
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok;
    } else { if ret == ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal { return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal; } }
    /* If apply_filters() will return ARCHIVE_OK, we can continue here. */
    if cdeque_size(&mut safe_rar.cstate.filters) >
        0 as libc::c_int as libc::c_ulong {
        ...
        if CDE_OK as libc::c_int !=
            cdeque_front(&mut safe_rar.cstate.filters,
                         cdeque_filter_p(&mut flt)) {
            archive_set_error_safe!(&mut (*a).archive as *mut archive,
                              ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_programmer,
                              b"Can\'t read first filter\x00" as *const u8 as
                                  *const libc::c_char);
            return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
        }
        max_end_pos =
            if unsafe { (*flt).block_start > safe_rar.cstate.write_ptr } {
                safe_rar.cstate.write_ptr
            } else { unsafe { (*flt).block_start } }
    } else {
...
extern "C" fn uncompress_file(mut a: *mut archive_read)
                              -> libc::c_int {
    let mut ret: libc::c_int = 0;
    loop {
        ...
        if ret != ARCHIVE_RAR5_DEFINED_PARAM.archive_retry { return ret; }
    };
}

extern "C" fn do_unstore_file(mut a: *mut archive_read,
                              mut rar: *mut rar5,
                              mut buf: *mut *const libc::c_void,
                              mut size: *mut size_t,
    ...
    to_read =
        if safe_rar.file.bytes_remaining >
            (64 as libc::c_int * 1024 as libc::c_int) as libc::c_long {
            (64 as libc::c_int * 1024 as libc::c_int) as libc::c_long
        } else { safe_rar.file.bytes_remaining } as size_t;
    ...
    if read_ahead(a, to_read, &mut p) == 0 {
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"I/O error when unstoring file\x00" as *const u8 as
                              *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    ...
    if !buf.is_null() { *safe_buf = p as *const libc::c_void }
    if !size.is_null() { *safe_size = to_read }
    if !offset.is_null() { *safe_offset = safe_rar.cstate.last_unstore_ptr }
    safe_rar.file.bytes_remaining =
        (safe_rar.file.bytes_remaining as libc::c_ulong).wrapping_sub(to_read)
            as ssize_t as ssize_t;
    safe_rar.cstate.last_unstore_ptr =
        (safe_rar.cstate.last_unstore_ptr as
            libc::c_ulong).wrapping_add(to_read) as int64_t as int64_t;
    update_crc(rar, p, to_read);
    return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok;
}

extern "C" fn do_unpack(mut a: *mut archive_read, mut rar: *mut rar5,
                        mut buf: *mut *const libc::c_void,
                        mut size: *mut size_t,
                        mut offset: *mut int64_t) -> libc::c_int {
    let safe_rar = unsafe { &mut *rar };
    if safe_rar.file.service() as libc::c_int > 0 as libc::c_int {
        ...
        match safe_rar.cstate.method {
            ...
            2 => { current_block_5 = 15727050098007377670; }
            4 => {
                /* fallthrough */
                current_block_5 = 961629404139379926;
            }
            3 | 5 => { current_block_5 = 961629404139379926; }
            _ => {
                archive_set_error_safe!(&mut (*a).archive as *mut archive,
                                  ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                                  b"Compression method not supported: 0x%x\x00"
                                      as *const u8 as *const libc::c_char,
                                  (*rar).cstate.method);
                return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
            }
...
extern "C" fn verify_checksums(mut a: *mut archive_read)
                               -> libc::c_int {
    let mut verify_crc: libc::c_int = 0;
    let mut rar: *mut rar5 = get_context(a);
    let safe_rar = unsafe { &mut *rar };
    ...
    if verify_crc != 0 {
            ...
            if safe_rar.file.calculated_crc32 != safe_rar.file.stored_crc32 {
                ...
                match () {
                    #[cfg(not(CHECK_CRC_ON_SOLID_SKIP))] _ => {
                        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                                          b"Checksum error: CRC32\x00" as *const u8 as
                                              *const libc::c_char);
                        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
                    }
                    #[cfg(CHECK_CRC_ON_SOLID_SKIP)] _ => {}
        ...
        if safe_rar.file.has_blake2 as libc::c_int > 0 as libc::c_int {
            ...
            blake2sp_final_safe(&mut safe_rar.file.b2state, b2_buf.as_mut_ptr(),
                                32 as libc::c_int as size_t);
            if memcmp_safe(&mut safe_rar.file.blake2sp as *mut [uint8_t; 32] as
                               *const libc::c_void,
                           b2_buf.as_mut_ptr() as *const libc::c_void,
                           32 as libc::c_int as libc::c_ulong) != 0 as libc::c_int
            {
                match () {
                    #[cfg(not(DONT_FAIL_ON_CRC_ERROR))] _ => {
                        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
...
extern "C" fn verify_global_checksums(mut a: *mut archive_read)
                                      -> libc::c_int {
 ...
 */
extern "C" fn rar5_signature(mut buf: *mut libc::c_char) {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < ::std::mem::size_of::<[libc::c_uchar; 8]>() as libc::c_ulong {
        unsafe {
            *buf.offset(i as isize) =
                (rar5_signature_xor[i as usize] as libc::c_int ^
...
extern "C" fn rar5_read_data(mut a: *mut archive_read,
    ...
    let safe_rar = unsafe { &mut *rar };
    let safe_size = unsafe { &mut *size };
    if !size.is_null() { *safe_size = 0 as libc::c_int as size_t }
    if safe_rar.file.dir() as libc::c_int > 0 as libc::c_int {
        ...
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_file_format,
                          b"Can\'t decompress an entry marked as a directory\x00"
                              as *const u8 as *const libc::c_char);
    ...
    if safe_rar.skip_mode == 0 &&
        ...
        archive_set_error_safe!(&mut (*a).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.archive_errno_programmer,
                          b"Unpacker has written too many bytes\x00" as
                              *const u8 as *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
...
extern "C" fn rar5_read_data_skip(mut a: *mut archive_read)
                                  -> libc::c_int {
    let mut rar: *mut rar5 = get_context(a);
    let safe_rar = unsafe { &mut *rar };
    if safe_rar.main.solid() != 0 {
        ...
        while safe_rar.file.bytes_remaining > 0 as libc::c_int as libc::c_long {
			 ...
			 * NULLs in arguments. */
            ret =
                rar5_read_data(a, 0 as *mut *const libc::c_void,
                               0 as *mut size_t, 0 as *mut int64_t);
            /* Turn off "skip mode". */
            safe_rar.skip_mode -= 1;
...
extern "C" fn rar5_seek_data(mut a: *mut archive_read,
                             mut offset: int64_t,
                             mut whence: libc::c_int) -> int64_t {
    /* We're a streaming unpacker, and we don't support seeking. */
    return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal as int64_t;
}

extern "C" fn rar5_cleanup(mut a: *mut archive_read) -> libc::c_int {
    let mut rar: *mut rar5 = get_context(a);
    let safe_rar = unsafe { &mut *rar };
    free_safe(safe_rar.cstate.window_buf as *mut libc::c_void);
    free_safe(safe_rar.cstate.filtered_buf as *mut libc::c_void);
...
extern "C" fn rar5_capabilities(mut a: *mut archive_read)
                                -> libc::c_int {
    return 0 as libc::c_int;
}

extern "C" fn rar5_has_encrypted_entries(mut _a: *mut archive_read)
                                         -> libc::c_int {
    /* Unsupported for now. */
    return ARCHIVE_RAR5_DEFINED_PARAM.archive_read_format_encryption_unsupported;
}

extern "C" fn rar5_init(mut rar: *mut rar5) -> libc::c_int {
    let safe_rar = unsafe { &mut *rar };
    memset_safe(rar as *mut libc::c_void, 0 as libc::c_int,
                ::std::mem::size_of::<rar5>() as libc::c_ulong);
    if CDE_OK as libc::c_int !=
        cdeque_init(&mut safe_rar.cstate.filters, 8192 as libc::c_int) {
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    return ARCHIVE_RAR5_DEFINED_PARAM.archive_ok;
}
...
pub extern "C" fn archive_read_support_format_rar5(mut _a:
    ...
    if ARCHIVE_RAR5_DEFINED_PARAM.archive_ok != ret { return ret; }
    rar = malloc_safe(::std::mem::size_of::<rar5>() as libc::c_ulong) as *mut rar5;
    if rar.is_null() {
        archive_set_error_safe!(&mut (*ar).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.enomem,
                          b"Can\'t allocate rar5 data\x00" as *const u8 as
                              *const libc::c_char);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    if ARCHIVE_RAR5_DEFINED_PARAM.archive_ok != rar5_init(rar) {
        archive_set_error_safe!(&mut (*ar).archive as *mut archive,
                          ARCHIVE_RAR5_DEFINED_PARAM.enomem,
                          b"Can\'t allocate rar5 filter buffer\x00" as
                              *const u8 as *const libc::c_char);
        free_safe(rar as *mut libc::c_void);
        return ARCHIVE_RAR5_DEFINED_PARAM.archive_fatal;
    }
    ret =
        __archive_read_register_format_safe(ar, rar as *mut libc::c_void,
                                            b"rar5\x00" as *const u8 as
                                                *const libc::c_char,
                                            Some(rar5_bid as
                                                extern "C" fn(_:
                                                              *mut archive_read,
                                            ...
                                            Some(rar5_options as
                                                extern "C" fn(_:
                                                              ...
                                                              *const libc::c_char)
                                                              -> libc::c_int),
                                            Some(rar5_read_header as
                                                extern "C" fn(_:
                                                              *mut archive_read,
                                                              _:
                                                              *mut archive_entry)
                                                              -> libc::c_int),
                                            Some(rar5_read_data as
                                                extern "C" fn(_:
                                                              *mut archive_read,
                                                              _:
                                                              ...
                                                              *mut int64_t)
                                                              -> libc::c_int),
                                            Some(rar5_read_data_skip as
                                                extern "C" fn(_:
                                                              *mut archive_read)
                                                              -> libc::c_int),
                                            Some(rar5_seek_data as
                                                extern "C" fn(_:
                                                              *mut archive_read,
                                                              _:
                                                              int64_t,
                                                              ...
                                                              libc::c_int)
                                                              -> int64_t),
                                            Some(rar5_cleanup as
                                                extern "C" fn(_:
                                                              *mut archive_read)
                                                              -> libc::c_int),
                                            Some(rar5_capabilities as
                                                extern "C" fn(_:
                                                              *mut archive_read)
                                                              -> libc::c_int),
                                            Some(rar5_has_encrypted_entries as
                                                extern "C" fn(_:
                                                              *mut archive_read)
                                                              -> libc::c_int));
    if ret != ARCHIVE_RAR5_DEFINED_PARAM.archive_ok { rar5_cleanup(ar); }
    return ret;
}
