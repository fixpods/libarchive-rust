...
pub  extern "C" fn archive_read_support_format_gnutar(mut a:
    ...
    let mut magic_test: libc::c_int =
        __archive_check_magic_safe(a, ARCHIVE_TAR_DEFINED_PARAM.archive_read_magic
                                   , ARCHIVE_TAR_DEFINED_PARAM.archive_state_new,
                                   b"archive_read_support_format_gnutar\x00" as
...
pub  extern "C" fn archive_read_support_format_tar(mut _a: *mut archive)
    ...
    let mut magic_test: libc::c_int =
        __archive_check_magic_safe(_a, ARCHIVE_TAR_DEFINED_PARAM.archive_read_magic,
                                   ARCHIVE_TAR_DEFINED_PARAM.archive_state_new,
                                   b"archive_read_support_format_tar\x00" as *const u8 as *const libc::c_char);
    if magic_test == ARCHIVE_TAR_DEFINED_PARAM.archive_fatal { return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal; }
    tar =
        calloc_safe(1 as libc::c_int as libc::c_ulong,
                    ::std::mem::size_of::<tar>() as libc::c_ulong) as *mut tar;
    let mut safe_tar=unsafe{&mut *tar};
    if tar.is_null() {
        archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                               ARCHIVE_TAR_DEFINED_PARAM.enomem,
                               b"Can\'t allocate tar data\x00" as *const u8 as
                                   *const libc::c_char);
        return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal
    }
    match () {
        #[cfg(HAVE_COPYFILE_H)]      _ => {
            safe_tar.process_mac_extensions = 1;
        }

        #[cfg(not(HAVE_COPYFILE_H))] _ => {}
    }
    r =
        __archive_read_register_format_safe(a, tar as *mut libc::c_void,
                                            b"tar\x00" as *const u8 as
                                                *const libc::c_char,
                                            Some(archive_read_format_tar_bid as
                                                extern "C" fn(_:
                                                              *mut archive_read,
                                                              _:
                                                              libc::c_int)
                                                              -> libc::c_int),
                                            Some(archive_read_format_tar_options as
                                                extern "C" fn(_:
                                                              *mut archive_read,
                                                              _:
                                                              *const libc::c_char,
                                            ...
                                            Some(archive_read_format_tar_read_data
                                                ...
                                                extern "C" fn(_:
                                                              ...
                                                              *mut int64_t)
                                                              -> libc::c_int),
                                            Some(archive_read_format_tar_skip as
                                                extern "C" fn(_:
                                                              *mut archive_read)
                                                              -> libc::c_int), None,
                                            Some(archive_read_format_tar_cleanup as
                                                extern "C" fn(_:
                                                              *mut archive_read)
                                                              -> libc::c_int), None,
                                            None);
    if r != ARCHIVE_TAR_DEFINED_PARAM.archive_ok { free_safe(tar as *mut libc::c_void); }
    return ARCHIVE_TAR_DEFINED_PARAM.archive_ok;
}
extern "C" fn archive_read_format_tar_cleanup(mut a: *mut archive_read)
                                              -> libc::c_int {
    let mut tar: *mut tar = 0 as *mut tar;
 ...
 */
extern "C" fn validate_number_field(mut p_field: *const libc::c_char,
                                    mut i_size: size_t)
                                    -> libc::c_int {
    ...
    if marker as libc::c_int == 128 as libc::c_int ||
        ...
        while i < i_size &&
            unsafe{*p_field.offset(i as isize) as libc::c_int} == ' ' as i32 {
            i = i.wrapping_add(1)
        }
        /* Skip octal digits. */
        while i < i_size &&
        ...
        while i < i_size {
            if unsafe{*p_field.offset(i as isize) as libc::c_int }!= ' ' as i32 &&
                unsafe{*p_field.offset(i as isize) as libc::c_int} !=
                    0 as libc::c_int {
...
extern "C" fn archive_read_format_tar_bid(mut a: *mut archive_read,
    ...
    let mut header: *const archive_entry_header_ustar =
        0 as *const archive_entry_header_ustar;
    /* UNUSED */
    bid = 0 as libc::c_int;
    /* Now let's look at the actual header and see if it matches. */
    h =
        __archive_read_ahead_safe(a, 512 as libc::c_int as size_t,
                                  0 as *mut ssize_t) as *const libc::c_char;
    ...
    if memcmp_safe(unsafe{(*header).magic.as_ptr() as *const libc::c_void},
                   b"ustar\x00\x00" as *const u8 as *const libc::c_char as
                       *const libc::c_void, 6 as libc::c_int as libc::c_ulong) ==
        0 as libc::c_int &&
        memcmp_safe(unsafe{(*header).version.as_ptr() as *const libc::c_void},
                    b"00\x00" as *const u8 as *const libc::c_char as
                        *const libc::c_void, 2 as libc::c_int as libc::c_ulong)
            == 0 as libc::c_int {
        bid += 56 as libc::c_int
    }
    /* Recognize GNU tar format. */
    if memcmp_safe(unsafe{(*header).magic.as_ptr() as *const libc::c_void},
                   b"ustar \x00" as *const u8 as *const libc::c_char as
                       *const libc::c_void, 6 as libc::c_int as libc::c_ulong) ==
        0 as libc::c_int &&
        memcmp_safe(unsafe{(*header).version.as_ptr() as *const libc::c_void},
    ...
    if unsafe{*header}.typeflag[0 as libc::c_int as usize] as libc::c_int !=
        0 as libc::c_int &&
        !(unsafe{*header}.typeflag[0 as libc::c_int as usize] as libc::c_int >=
            '0' as i32 &&
            unsafe{*header}.typeflag[0 as libc::c_int as usize] as libc::c_int
                <= '9' as i32) &&
        !(unsafe{*header}.typeflag[0 as libc::c_int as usize] as libc::c_int >=
    ...
    if bid > 0 as libc::c_int &&
        (validate_number_field(unsafe{*header}.mode.as_ptr(),
                               ::std::mem::size_of::<[libc::c_char; 8]>()
                                   as libc::c_ulong) == 0 as libc::c_int ||
            validate_number_field(unsafe{*header}.uid.as_ptr(),
                                  ::std::mem::size_of::<[libc::c_char; 8]>()
                                      as libc::c_ulong) ==
                0 as libc::c_int ||
            validate_number_field(unsafe{*header}.gid.as_ptr(),
                                  ::std::mem::size_of::<[libc::c_char; 8]>()
                                      as libc::c_ulong) ==
                0 as libc::c_int ||
            validate_number_field(unsafe{*header}.mtime.as_ptr(),
                                  ::std::mem::size_of::<[libc::c_char; 12]>()
                                      as libc::c_ulong) ==
                0 as libc::c_int ||
            validate_number_field(unsafe{*header}.size.as_ptr(),
                                  ::std::mem::size_of::<[libc::c_char; 12]>()
                                      as libc::c_ulong) ==
                0 as libc::c_int ||
            validate_number_field(unsafe{*header}.rdevmajor.as_ptr(),
                                  ::std::mem::size_of::<[libc::c_char; 8]>()
                                      as libc::c_ulong) ==
                0 as libc::c_int ||
            validate_number_field(unsafe{*header}.rdevminor.as_ptr(),
                                  ::std::mem::size_of::<[libc::c_char; 8]>()
                                      as libc::c_ulong) ==
                0 as libc::c_int) {
        bid = 0 as libc::c_int
...
extern "C" fn archive_read_format_tar_options(mut a: *mut archive_read,
                                              mut key:
                                              *const libc::c_char,
                                              mut val:
                                              *const libc::c_char)
    ...
    let mut safe_tar=unsafe{&mut *tar};
    let mut safe_a=unsafe{&mut *a};
    if strcmp_safe(key, b"compat-2x\x00" as *const u8 as *const libc::c_char) ==
        0 as libc::c_int {
        ...
        if strcmp_safe(key, b"hdrcharset\x00" as *const u8 as *const libc::c_char)
            ...
            if val.is_null() ||
                ...
                archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                       ...
                                       b"tar: hdrcharset option needs a character-set name\x00"
                                           as *const u8 as *const libc::c_char);
            } else {
                safe_tar.opt_sconv =
                    archive_string_conversion_from_charset_safe(&mut safe_a.archive,
                                                                val,
                                                                0 as libc::c_int);
                if !safe_tar.opt_sconv.is_null() {
                    ret = ARCHIVE_TAR_DEFINED_PARAM.archive_ok
                } else { ret = ARCHIVE_TAR_DEFINED_PARAM.archive_fatal }
            }
            return ret
        } else {
            if strcmp_safe(key, b"mac-ext\x00" as *const u8 as *const libc::c_char)
                ...
                if strcmp_safe(key,
                               b"read_concatenated_archives\x00" as *const u8 as
                                   *const libc::c_char) == 0 as libc::c_int {
                    safe_tar.read_concatenated_archives =
                        (!val.is_null() &&
                            unsafe{ *val.offset(0 as libc::c_int as isize) as
 ...
 */
extern "C" fn tar_flush_unconsumed(mut a: *mut archive_read,
 ...
 */
extern "C" fn archive_read_format_tar_read_header(mut a:
                                                  *mut archive_read,
                                                  mut entry:
                                                  *mut archive_entry)
                                                  -> libc::c_int {
    ...
    archive_entry_set_dev_safe(entry,
                               (1 as libc::c_int + default_dev) as
                                   dev_t); /* Don't use zero. */
    ...
    if safe_tar.sparse_list.is_null() {
        if gnu_add_sparse_entry(a, tar, 0 as libc::c_int as int64_t,
        ...
        while !sb.is_null() {
            if unsafe{(*sb)}.hole == 0 {
                archive_entry_sparse_add_entry_safe(entry, unsafe{(*sb)}.offset,
                                                    unsafe{(*sb)}.remaining);
            }
            unsafe{sb = (*sb).next}
        }
        ...
        archive_entry_filetype_safe(entry) == ARCHIVE_TAR_DEFINED_PARAM.ae_ifreg as mode_t
    {
        ...
        if !wp.is_null() {
            ...
            if l > 0 as libc::c_int as libc::c_ulong &&
                unsafe {*wp.offset(l.wrapping_sub(1 as libc::c_int as
                    libc::c_ulong) as isize)} ==
                    '/' as i32 {
                archive_entry_set_filetype_safe(entry,
            ...
            if !p.is_null() {
                l = strlen_safe(p);
                if l > 0 as libc::c_int as libc::c_ulong &&
                    unsafe{ *p.offset(l.wrapping_sub(1 as libc::c_int as
                        libc::c_ulong) as isize)
                        as libc::c_int }== '/' as i32 {
                    archive_entry_set_filetype_safe(entry,
                                                    ARCHIVE_TAR_DEFINED_PARAM.ae_ifdir as
                                                        mode_t);
                }
            }
        }
...
extern "C" fn archive_read_format_tar_read_data(mut a:
                                                *mut archive_read,
                                                mut buff:
                                                *mut *const libc::c_void,
                                                mut size: *mut size_t,
    ...
    loop  {
        ...
        while !safe_tar.sparse_list.is_null() &&
            unsafe{(*safe_tar.sparse_list)}.remaining ==
        ...
        unsafe { *buff =
            __archive_read_ahead_safe(a, 1 as libc::c_int as size_t,
                                      &mut bytes_read)};
        ...
        if unsafe{*buff} == 0 as *mut libc::c_void {
            archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                   ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                   b"Truncated tar archive\x00" as *const u8 as
                                       *const libc::c_char);
            return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal
        }
        ...
        unsafe{if (*safe_tar.sparse_list).remaining < bytes_read {
            bytes_read = (*safe_tar.sparse_list).remaining
        }}
        unsafe{*size = bytes_read as size_t};
        unsafe { *offset = (*safe_tar.sparse_list).offset;
        ...
        if unsafe{(*safe_tar.sparse_list).hole} == 0 { return ARCHIVE_TAR_DEFINED_PARAM.archive_ok }
    };
}
 extern "C" fn archive_read_format_tar_skip(mut a: *mut archive_read)
                                                  -> libc::c_int {
 ...
 * with a single entry.
 */
extern "C" fn tar_read_header(mut a: *mut archive_read,
                              mut tar: *mut tar,
    ...
    let mut gnuheader: *const archive_entry_header_gnutar =
        0 as *const archive_entry_header_gnutar;
    ...
    /* Loop until we find a workable header record. */
    {
        ...
        h =
            __archive_read_ahead_safe(a, 512 as libc::c_int as size_t, &mut bytes)
        ...
        if unsafe{*h.offset(0 as libc::c_int as isize) as libc::c_int} !=
            0 as libc::c_int || archive_block_is_null(h) == 0 {
            break ;
        }
    ...
    if checksum(a, h as *const libc::c_void) == 0 {
        ...
        archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                               ...
                               b"Damaged tar archive\x00" as *const u8 as
                                   *const libc::c_char);
    ...
    if safe_tar.header_recursion_depth > 32 as libc::c_int {
        ...
        archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                               ARCHIVE_TAR_DEFINED_PARAM.einval,
                               b"Too many special headers\x00" as *const u8 as
                                   *const libc::c_char);
        return ARCHIVE_TAR_DEFINED_PARAM.archive_warn
    }
    ...
    match unsafe{*header}.typeflag[0 as libc::c_int as usize] as libc::c_int {
        65 => {
            ...
            err =
                header_Solaris_ACL(a, tar, entry, h as *const libc::c_void,
                                   unconsumed)
        }
        103 => {
            ...
            safe_a.archive.archive_format =
                ARCHIVE_TAR_DEFINED_PARAM.archive_format_tar_pax_interchange;
            safe_a.archive.archive_format_name =
                b"POSIX pax interchange format\x00" as *const u8 as
                    *const libc::c_char;
            err =
                header_pax_global(a, tar, entry, h as *const libc::c_void,
                                  unconsumed);
            if err == ARCHIVE_TAR_DEFINED_PARAM.archive_eof { return err }
        }
        75 => {
            /* Long link name (GNU tar, others) */
            err =
                header_longlink(a, tar, entry, h as *const libc::c_void,
                                unconsumed)
        }
        76 => {
            /* Long filename (GNU tar, others) */
            err =
                header_longname(a, tar, entry, h as *const libc::c_void,
                                unconsumed)
        }
        86 => {
            /* GNU volume header */
            err =
                header_volume(a, tar, entry, h as *const libc::c_void,
                              unconsumed);
            if err == ARCHIVE_TAR_DEFINED_PARAM.archive_eof { eof_vol_header = 1 as libc::c_int }
        }
        88 => {
            ...
            safe_a.archive.archive_format_name =
                b"POSIX pax interchange format (Sun variant)\x00" as *const u8
                    as *const libc::c_char;
            err =
                header_pax_extensions(a, tar, entry, h as *const libc::c_void,
                                      unconsumed)
        }
        120 => {
        ...
        _ => {
            ...
            if memcmp_safe(unsafe{(*gnuheader)}.magic.as_ptr() as *const libc::c_void,
                           b"ustar  \x00\x00" as *const u8 as *const libc::c_char
                ...
                err =
                    header_gnutar(a, tar, entry, h as *const libc::c_void,
                                  unconsumed)
            } else if memcmp_safe(unsafe{*header}.magic.as_ptr() as *const libc::c_void,
                ...
                if safe_a.archive.archive_format !=
                    ...
                    safe_a.archive.archive_format_name =
                        b"POSIX ustar format\x00" as *const u8 as
                            *const libc::c_char
                }
                ...
                safe_a.archive.archive_format = ARCHIVE_TAR_DEFINED_PARAM.archive_format_tar;
                safe_a.archive.archive_format_name =
                    b"tar (non-POSIX)\x00" as *const u8 as
                        *const libc::c_char;
                err = header_old_tar(a, tar, entry, h as *const libc::c_void)
            }
        }
    }
    if err == ARCHIVE_TAR_DEFINED_PARAM.archive_fatal { return err }
    tar_flush_unconsumed(a, unconsumed);
    ...
    if (err == ARCHIVE_TAR_DEFINED_PARAM.archive_warn ||
        ...
        let mut err2: libc::c_int =
            read_mac_metadata_blob(a, tar, entry, h as *const libc::c_void,
                                   unconsumed);
    ...
    if err == ARCHIVE_TAR_DEFINED_PARAM.archive_warn ||
        ...
        if safe_tar.sparse_gnu_pending != 0 {
            if safe_tar.sparse_gnu_major == 1 as libc::c_int &&
                ...
                archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                       ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                       b"Unrecognized GNU sparse file format\x00"
                                           as *const u8 as *const libc::c_char);
                return ARCHIVE_TAR_DEFINED_PARAM.archive_warn
            }
            safe_tar.sparse_gnu_pending = 0 as libc::c_int as libc::c_char
 ...
 */
extern "C" fn checksum(mut a: *mut archive_read,
                       mut h: *const libc::c_void) -> libc::c_int {
	 ...
	 */
    sum =
        tar_atol(unsafe{*header}.checksum.as_ptr(),
    ...
    if sum == check { return 1 as libc::c_int }
    /*
 ...
 */
extern "C" fn archive_block_is_null(mut p: *const libc::c_char)
                                    -> libc::c_int {
    ...
    while i < 512 as libc::c_int as libc::c_uint {
        let fresh0 = p;
        unsafe {p = p.offset(1)};
        if unsafe{*fresh0} != 0 { return 0 as libc::c_int }
        i = i.wrapping_add(1)
    }
    return 1 as libc::c_int;
}
 ...
 */
extern "C" fn header_Solaris_ACL(mut a: *mut archive_read,
                                 mut tar: *mut tar,
                                 mut entry: *mut archive_entry,
    ...
    while unsafe{*p as libc::c_int != '\u{0}' as i32 && p < acl.offset(size as isize)}
    {
        if unsafe{(*p as libc::c_int) < '0' as i32 || *p as libc::c_int > '7' as i32}
        {
            archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                   ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                   b"Malformed Solaris ACL attribute (invalid digit)\x00"
                                       as *const u8 as *const libc::c_char);
            return ARCHIVE_TAR_DEFINED_PARAM.archive_warn
        }
        ...
        if type_0 > 0o77777777 as libc::c_int as libc::c_long {
            archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                   ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                   b"Malformed Solaris ACL attribute (count too large)\x00"
                                       as *const u8 as *const libc::c_char);
            return ARCHIVE_TAR_DEFINED_PARAM.archive_warn
        }
        unsafe{p = p.offset(1)}
    ...
    match type_0 as libc::c_int & !(0o777777 as libc::c_int) {
        ...
        _ => {
            archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                     ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                     b"Malformed Solaris ACL attribute (unsupported type %o)\x00"
                                         as *const u8 as *const libc::c_char,
    ...
    if p >= unsafe{acl.offset(size as isize)} {
        archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                               ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                               b"Malformed Solaris ACL attribute (body overflow)\x00"
                                   as *const u8 as *const libc::c_char);
        return ARCHIVE_TAR_DEFINED_PARAM.archive_warn
    }
    ...
    size =
        (size as
            libc::c_ulong).wrapping_sub(unsafe{p.offset_from(acl)} as
            libc::c_long as libc::c_ulong) as
            size_t as size_t;
    acl = p;
    unsafe{while *p as libc::c_int != '\u{0}' as i32 && p < acl.offset(size as isize)
    {
        p = p.offset(1)
    }}
        ...
        safe_tar.sconv_acl =
            archive_string_conversion_from_charset_safe(&mut safe_a.archive,
                                                        b"UTF-8\x00" as *const u8
                                                            as *const libc::c_char,
                                                        1 as libc::c_int);
        if safe_tar.sconv_acl.is_null() { return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal }
    }
    safe_tar.localname.length = 0 as libc::c_int as size_t;
    archive_strncat_safe(&mut safe_tar.localname, acl as *const libc::c_void,
                         unsafe{p.offset_from(acl) as libc::c_long as size_t});
    err =
        archive_acl_from_text_l_safe(archive_entry_acl_safe(entry), safe_tar.localname.s,
                                     acl_type, safe_tar.sconv_acl);
    if err != ARCHIVE_TAR_DEFINED_PARAM.archive_ok {
        if unsafe{*__errno_location() == ARCHIVE_TAR_DEFINED_PARAM.enomem }{
            archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                   ARCHIVE_TAR_DEFINED_PARAM.enomem,
                                   b"Can\'t allocate memory for ACL\x00" as
                                       *const u8 as *const libc::c_char);
        } else {
            archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                   ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                   b"Malformed Solaris ACL attribute (unparsable)\x00"
                                       as *const u8 as *const libc::c_char);
        }
    }
    return err;
 ...
 */
extern "C" fn header_longlink(mut a: *mut archive_read,
                              mut tar: *mut tar,
                              mut entry: *mut archive_entry,
                              mut h: *const libc::c_void,
                              mut unconsumed: *mut size_t)
...
extern "C" fn set_conversion_failed_error(mut a: *mut archive_read,
                                          mut sconv:
    ...
    if unsafe{*__errno_location()} == ARCHIVE_TAR_DEFINED_PARAM.enomem {
        archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                  ARCHIVE_TAR_DEFINED_PARAM.enomem ,
                                  b"Can\'t allocate memory for %s\x00" as *const u8 as
                                      *const libc::c_char, name);
        return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal
    }
    archive_set_error_safe!(&mut safe_a.archive as *mut archive, ARCHIVE_TAR_DEFINED_PARAM.archive_errno_file_format ,
                              b"%s can\'t be converted from %s to current locale.\x00"
 ...
 */
extern "C" fn header_longname(mut a: *mut archive_read,
                              mut tar: *mut tar,
                              mut entry: *mut archive_entry,
                              mut h: *const libc::c_void,
                              mut unconsumed: *mut size_t)
    ...
    if err != ARCHIVE_TAR_DEFINED_PARAM.archive_ok &&
        err != ARCHIVE_TAR_DEFINED_PARAM.archive_warn { return err }
    if _archive_entry_copy_pathname_l_safe(entry, safe_tar.longname.s,
                                           safe_tar.longname.length, safe_tar.sconv) !=
        0 as libc::c_int {
        err =
            set_conversion_failed_error(a, safe_tar.sconv,
                                        b"Pathname\x00" as *const u8 as
                                            *const libc::c_char)
    }
    return err;
}
 ...
 */
extern "C" fn header_volume(mut a: *mut archive_read,
                            mut tar: *mut tar,
                            mut entry: *mut archive_entry,
                            mut h: *const libc::c_void,
                            mut unconsumed: *mut size_t)
 ...
 */
extern "C" fn read_body_to_string(mut a: *mut archive_read,
                                  mut tar: *mut tar,
    ...
    size =
        tar_atol(unsafe{*header}.size.as_ptr(),
                 ::std::mem::size_of::<[libc::c_char; 12]>() as
                     libc::c_ulong);
    if size > 1048576 as libc::c_int as libc::c_long ||
        size < 0 as libc::c_int as libc::c_long {
        archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                               ARCHIVE_TAR_DEFINED_PARAM.einval,
                               b"Special header too large\x00" as *const u8 as
                                   *const libc::c_char);
        return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal
    }
    /* Fail if we can't make our buffer big enough. */
    if archive_string_ensure_safe(as_0,
                                  (size as
    ...
    unsafe {*unconsumed =
        (size + 511 as libc::c_int as libc::c_long &
 ...
 */
extern "C" fn header_common(mut a: *mut archive_read,
                            mut tar: *mut tar,
                            mut entry: *mut archive_entry,
                            mut h: *const libc::c_void)
                            -> libc::c_int {
    ...
    if unsafe{*header}.linkname[0 as libc::c_int as usize] != 0 {
        ...
        archive_strncat_safe(&mut safe_tar.entry_linkpath,
                             unsafe{*header}.linkname.as_ptr() as *const libc::c_void,
                             ::std::mem::size_of::<[libc::c_char; 100]>() as
                                 libc::c_ulong);
    } else { safe_tar.entry_linkpath.length = 0 as libc::c_int as size_t }
    /* Parse out the numeric fields (all are octal) */
    archive_entry_set_mode_safe(entry,
                                tar_atol(unsafe{*header}.mode.as_ptr(),
                                         ::std::mem::size_of::<[libc::c_char; 8]>()
                                             as libc::c_ulong) as mode_t);
    archive_entry_set_uid_safe(entry,
                               tar_atol(unsafe{*header}.uid.as_ptr(),
                                        ::std::mem::size_of::<[libc::c_char; 8]>()
                                            as libc::c_ulong));
    archive_entry_set_gid_safe(entry,
                               tar_atol(unsafe{*header}.gid.as_ptr(),
                                        ::std::mem::size_of::<[libc::c_char; 8]>()
                                            as libc::c_ulong));
    safe_tar.entry_bytes_remaining =
        tar_atol(unsafe{*header}.size.as_ptr(),
    ...
    if safe_tar.entry_bytes_remaining < 0 as libc::c_int as libc::c_long {
        ...
        archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                               ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                               b"Tar entry has negative size\x00" as *const u8 as
                                   *const libc::c_char);
        return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal
    }
    if safe_tar.entry_bytes_remaining == 9223372036854775807 as libc::c_long {
        ...
        archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                               ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                               b"Tar entry size overflow\x00" as *const u8 as
                                   *const libc::c_char);
        return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal
    }
    safe_tar.realsize = safe_tar.entry_bytes_remaining;
    archive_entry_set_size_safe(entry, safe_tar.entry_bytes_remaining);
    archive_entry_set_mtime_safe(entry,
                                 tar_atol(unsafe{*header}.mtime.as_ptr(),
                                          ::std::mem::size_of::<[libc::c_char; 12]>()
                                              as libc::c_ulong),
                                 0 as libc::c_int as libc::c_long);
    ...
    match tartype as libc::c_int {
        49 => {
            /* Hard link */
            if _archive_entry_copy_hardlink_l_safe(entry, safe_tar.entry_linkpath.s,
                                                   safe_tar.entry_linkpath.length,
                                                   safe_tar.sconv) !=
                0 as libc::c_int {
                err =
                    set_conversion_failed_error(a, safe_tar.sconv,
                                                b"Linkname\x00" as *const u8
                                                    as *const libc::c_char);
                if err == ARCHIVE_TAR_DEFINED_PARAM.archive_fatal { return err }
            }
            /*
		 ...
		 */
            if !(archive_entry_size_safe(entry) ==
                0 as libc::c_int as libc::c_long) {
                if !(safe_a.archive.archive_format ==
                    ARCHIVE_TAR_DEFINED_PARAM.archive_format_tar_pax_interchange) {
                    if safe_a.archive.archive_format == ARCHIVE_TAR_DEFINED_PARAM.archive_format_tar
                        ...
                        archive_entry_set_size_safe(entry,
                                                    0 as libc::c_int as
                                                        la_int64_t);
                        safe_tar.entry_bytes_remaining =
                            0 as libc::c_int as int64_t
                    } else if archive_read_format_tar_bid(a,
                                                          50 as libc::c_int) >
                        50 as libc::c_int {
                        /*
        ...
        50 => {
            ...
            safe_tar.entry_bytes_remaining = 0 as libc::c_int as int64_t;
            if _archive_entry_copy_symlink_l_safe(entry, safe_tar.entry_linkpath.s,
                                                  safe_tar.entry_linkpath.length,
                                                  safe_tar.sconv) != 0 as libc::c_int
            {
                err =
                    set_conversion_failed_error(a, safe_tar.sconv,
                                                b"Linkname\x00" as *const u8
        ...
        77 => { current_block_64 = 5372832139739605200; }
        78 => {
        ...
        _ => { current_block_64 = 1050378859040334210; }
    }
 ...
 */
extern "C" fn header_old_tar(mut a: *mut archive_read,
                             mut tar: *mut tar,
                             mut entry: *mut archive_entry,
                             mut h: *const libc::c_void)
                             -> libc::c_int {
    ...
    header = h as *const archive_entry_header_ustar;
    if _archive_entry_copy_pathname_l_safe(entry, unsafe{*header}.name.as_ptr(),
                                           ::std::mem::size_of::<[libc::c_char; 100]>()
                                               as libc::c_ulong, safe_tar.sconv) !=
        0 as libc::c_int {
        err =
            set_conversion_failed_error(a, safe_tar.sconv,
                                        b"Pathname\x00" as *const u8 as
                                            *const libc::c_char);
        if err == -(30 as libc::c_int) { return err }
    }
    /* Grab rest of common fields */
    err2 = header_common(a, tar, entry, h);
    if err > err2 { err = err2 }
    safe_tar.entry_padding =
        0x1ff as libc::c_int as libc::c_long & -safe_tar.entry_bytes_remaining;
    return err;
}
/*
 ...
 * if there is one.
 */
extern "C" fn read_mac_metadata_blob(mut a: *mut archive_read,
                                     mut tar: *mut tar,
                                     mut entry: *mut archive_entry,
                                     mut h: *const libc::c_void,
                                     mut unconsumed: *mut size_t)
    ...
    if !wp.is_null() {
        ...
        while unsafe{*wp }!= '\u{0}' as i32 {
            if unsafe{*wp.offset(0 as libc::c_int as isize) == '/' as i32 &&
		 ...
		 */
        if unsafe{*wname.offset(0 as libc::c_int as isize) != '.' as i32 ||
        ...
        p = archive_entry_pathname_safe(entry);
        name = p;
        if p.is_null() { return ARCHIVE_TAR_DEFINED_PARAM.archive_failed }
        while unsafe{*p as libc::c_int} != '\u{0}' as i32 {
            if unsafe{*p.offset(0 as libc::c_int as isize)} as libc::c_int ==
                '/' as i32 &&
                unsafe {*p.offset(1 as libc::c_int as isize)} as libc::c_int !=
                    '\u{0}' as i32 {
		 ...
		 * this is a Mac extension.
		 */
        if unsafe{*name.offset(0 as libc::c_int as isize) as libc::c_int !=
            '.' as i32 ||
 ...
 */
extern "C" fn header_pax_global(mut a: *mut archive_read,
                                mut tar: *mut tar,
                                mut entry: *mut archive_entry,
                                mut h: *const libc::c_void,
                                mut unconsumed: *mut size_t)
    ...
    if err != 0 as libc::c_int { return err }
    err = tar_read_header(a, tar, entry, unconsumed);
    return err;
}
extern "C" fn header_pax_extensions(mut a: *mut archive_read,
                                    mut tar: *mut tar,
                                    mut entry: *mut archive_entry,
                                    mut h: *const libc::c_void,
                                    mut unconsumed: *mut size_t)
    ...
    err = tar_read_header(a, tar, entry, unconsumed);
    if err != ARCHIVE_TAR_DEFINED_PARAM.archive_ok && err != ARCHIVE_TAR_DEFINED_PARAM.archive_warn { return err }
    /*
 ...
 */
extern "C" fn header_ustar(mut a: *mut archive_read, mut tar: *mut tar,
                           mut entry: *mut archive_entry,
                           mut h: *const libc::c_void) -> libc::c_int {
    let mut header: *const archive_entry_header_ustar =
        0 as *const archive_entry_header_ustar;
    ...
    if unsafe{*header}.prefix[0 as libc::c_int as usize] != 0 {
        ...
        archive_strncat_safe(as_0,
                             unsafe{*header}.prefix.as_ptr() as *const libc::c_void,
                             ::std::mem::size_of::<[libc::c_char; 155]>() as
                                 libc::c_ulong);
        if unsafe{*safe_as_0.s.offset(safe_as_0.length.wrapping_sub(1 as libc::c_int as
            libc::c_ulong) as
            isize) as libc::c_int} != '/' as i32 {
            archive_strappend_char_safe(as_0, '/' as i32 as libc::c_char);
        }
        archive_strncat_safe(as_0, unsafe{*header}.name.as_ptr() as *const libc::c_void,
                             ::std::mem::size_of::<[libc::c_char; 100]>() as
                                 libc::c_ulong);
    } else {
        safe_as_0.length = 0 as libc::c_int as size_t;
    ...
    if _archive_entry_copy_pathname_l_safe(entry, safe_as_0.s, safe_as_0.length,
                                           safe_tar.sconv) != 0 as libc::c_int {
        err =
            set_conversion_failed_error(a, safe_tar.sconv,
                                        b"Pathname\x00" as *const u8 as
    ...
    if r == ARCHIVE_TAR_DEFINED_PARAM.archive_fatal { return r }
    if r < err { err = r }
    /* Handle POSIX ustar fields. */
    if _archive_entry_copy_uname_l_safe(entry, unsafe{*header}.uname.as_ptr(),
                                        ::std::mem::size_of::<[libc::c_char; 32]>()
                                            as libc::c_ulong, safe_tar.sconv) !=
        0 as libc::c_int {
        err =
            set_conversion_failed_error(a, safe_tar.sconv,
                                        b"Uname\x00" as *const u8 as
                                            *const libc::c_char);
        if err == ARCHIVE_TAR_DEFINED_PARAM.archive_fatal { return err }
    }
    if _archive_entry_copy_gname_l_safe(entry, unsafe{*header}.gname.as_ptr(),
                                        ::std::mem::size_of::<[libc::c_char; 32]>()
                                            as libc::c_ulong, safe_tar.sconv) !=
        0 as libc::c_int {
        err =
            set_conversion_failed_error(a, safe_tar.sconv,
                                        b"Gname\x00" as *const u8 as
                                            *const libc::c_char);
        if err == ARCHIVE_TAR_DEFINED_PARAM.archive_fatal { return err }
    }
    ...
    if unsafe{*header}.typeflag[0 as libc::c_int as usize] as libc::c_int ==
        ...
        unsafe {(*header)}.typeflag[0 as libc::c_int as usize] as libc::c_int ==
            '4' as i32 {
        archive_entry_set_rdevmajor_safe(entry,
                                         tar_atol(unsafe{*header}.rdevmajor.as_ptr(),
                                                  ::std::mem::size_of::<[libc::c_char; 8]>()
                                                      as libc::c_ulong) as dev_t);
        archive_entry_set_rdevminor_safe(entry,
                                         tar_atol(unsafe{*header}.rdevminor.as_ptr(),
                                                  ::std::mem::size_of::<[libc::c_char; 8]>()
                                                      as libc::c_ulong) as dev_t);
    }
    safe_tar.entry_padding =
 ...
 */
extern "C" fn pax_header(mut a: *mut archive_read, mut tar: *mut tar,
                         mut entry: *mut archive_entry,
    ...
    while attr_length > 0 as libc::c_int as libc::c_ulong {
        ...
        while l > 0 as libc::c_int as libc::c_ulong {
            if unsafe{*p as libc::c_int} == ' ' as i32 {
                ...
                if unsafe{(*p as libc::c_int) < '0' as i32 ||
                    *p as libc::c_int > '9' as i32} {
                    archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                           ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                           b"Ignoring malformed pax extended attributes\x00"
                                               as *const u8 as
                                               *const libc::c_char);
                    return ARCHIVE_TAR_DEFINED_PARAM.archive_warn
                }
                ...
                line_length =
                    (line_length as
                        libc::c_ulong).wrapping_add((unsafe{*p as libc::c_int} -
                        '0' as i32) as
                        libc::c_ulong) as
                        size_t as size_t;
                if line_length > 999999 as libc::c_int as libc::c_ulong {
                    archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                           ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                           b"Rejecting pax extended attribute > 1MB\x00"
                                               as *const u8 as
                                               *const libc::c_char);
                    return ARCHIVE_TAR_DEFINED_PARAM.archive_warn
                }
        ...
        if line_length > attr_length ||
            ...
            unsafe{*attr.offset(line_length.wrapping_sub(1 as libc::c_int as
                libc::c_ulong) as
                isize) as libc::c_int} != '\n' as i32 {
            archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                   ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                   b"Ignoring malformed pax extended attribute\x00"
                                       as *const u8 as *const libc::c_char);
            return ARCHIVE_TAR_DEFINED_PARAM.archive_warn
        }
        ...
        unsafe{while *p as libc::c_int != 0 && *p as libc::c_int != '=' as i32 {
            p = p.offset(1)
        }}
        if unsafe{*p as libc::c_int} == '\u{0}' as i32 {
            archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                   ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                   b"Invalid pax extended attributes\x00" as
                                       *const u8 as *const libc::c_char);
            return ARCHIVE_TAR_DEFINED_PARAM.archive_warn
        }
        ...
        value_length =
            unsafe{attr.offset(line_length as
                isize).offset(-(1 as libc::c_int as
                isize)).offset_from(value)
                as libc::c_long as size_t};
        /* Identify this attribute and set it in the entry. */
        err2 = pax_attribute(a, tar, entry, key, value, value_length);
        if err2 == ARCHIVE_TAR_DEFINED_PARAM.archive_fatal { return err2 }
        err = if err < err2 { err } else { err2 };
        /* Skip to next line */
        unsafe{attr = attr.offset(line_length as isize)};
        attr_length =
            (attr_length as libc::c_ulong).wrapping_sub(line_length) as size_t
                as size_t
    }
    /*
        ...
        sconv =
            archive_string_conversion_from_charset_safe(&mut safe_a.archive,
                                                        b"UTF-8\x00" as *const u8
                                                            as *const libc::c_char,
                                                        1 as libc::c_int);
        if sconv.is_null() { return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal }
        if safe_tar.compat_2x != 0 {
            archive_string_conversion_set_opt_safe(sconv,
                                                   ARCHIVE_TAR_DEFINED_PARAM.sconv_set_opt_utf8_libarchive2x);
        }
    }
    if safe_tar.entry_gname.length > 0 as libc::c_int as libc::c_ulong {
        if _archive_entry_copy_gname_l_safe(entry, safe_tar.entry_gname.s,
                                            safe_tar.entry_gname.length, sconv) !=
            0 as libc::c_int {
            err =
                set_conversion_failed_error(a, sconv,
                                            b"Gname\x00" as *const u8 as
                                                *const libc::c_char);
            if err == ARCHIVE_TAR_DEFINED_PARAM.archive_fatal { return err }
    ...
    if safe_tar.entry_linkpath.length > 0 as libc::c_int as libc::c_ulong {
        if _archive_entry_copy_link_l_safe(entry, safe_tar.entry_linkpath.s,
                                           safe_tar.entry_linkpath.length, sconv) !=
            0 as libc::c_int {
            err =
                set_conversion_failed_error(a, sconv,
                                            b"Linkname\x00" as *const u8 as
                                                *const libc::c_char);
            if err ==ARCHIVE_TAR_DEFINED_PARAM.archive_fatal { return err }
            /* Use a converted an original name. */
    ...
    if safe_tar.entry_pathname_override.length >
    ...
    if safe_tar.entry_uname.length > 0 as libc::c_int as libc::c_ulong {
        if _archive_entry_copy_uname_l_safe(entry, safe_tar.entry_uname.s,
                                            safe_tar.entry_uname.length, sconv) !=
            0 as libc::c_int {
            err =
                set_conversion_failed_error(a, sconv,
                                            b"Uname\x00" as *const u8 as
...
extern "C" fn pax_attribute_xattr(mut entry: *mut archive_entry,
    ...
    if strlen_safe(name) < 18 as libc::c_int as libc::c_ulong ||
        memcmp_safe(name as *const libc::c_void,
                    b"LIBARCHIVE.xattr.\x00" as *const u8 as *const libc::c_char
                        as *const libc::c_void,
                    17 as libc::c_int as libc::c_ulong) != 0 as libc::c_int {
        return 3 as libc::c_int
    }
    unsafe{name = name.offset(17 as libc::c_int as isize)};
    /* URL-decode name */
    name_decoded = url_decode(name);
    if name_decoded.is_null() { return 2 as libc::c_int }
    /* Base-64 decode value */
    value_decoded =
        base64_decode(value, strlen_safe(value), &mut value_len) as
            *mut libc::c_void;
    if value_decoded.is_null() {
        free_safe(name_decoded as *mut libc::c_void);
        return 1 as libc::c_int
    }
    archive_entry_xattr_add_entry_safe(entry, name_decoded, value_decoded,
                                       value_len);
    free_safe(name_decoded as *mut libc::c_void);
    free_safe(value_decoded);
    return 0 as libc::c_int;
}
extern "C" fn pax_attribute_schily_xattr(mut entry: *mut archive_entry,
                                         mut name: *const libc::c_char,
                                         mut value:
                                         *const libc::c_char,
    ...
    if strlen_safe(name) < 14 as libc::c_int as libc::c_ulong ||
        memcmp_safe(name as *const libc::c_void,
                    b"SCHILY.xattr.\x00" as *const u8 as *const libc::c_char as
                        *const libc::c_void, 13 as libc::c_int as libc::c_ulong)
            != 0 as libc::c_int {
        return 1 as libc::c_int
    }
    unsafe{name = name.offset(13 as libc::c_int as isize)};
    archive_entry_xattr_add_entry_safe(entry, name, value as *const libc::c_void,
                                       value_length);
    return 0 as libc::c_int;
}
extern "C" fn pax_attribute_rht_security_selinux(mut entry:
                                                 *mut archive_entry,
                                                 mut value:
                                                 *const libc::c_char,
                                                 mut value_length:
                                                 size_t)
                                                 -> libc::c_int {
    archive_entry_xattr_add_entry_safe(entry,
                                       b"security.selinux\x00" as *const u8 as
                                           *const libc::c_char,
                                       value as *const libc::c_void, value_length);
    return 0 as libc::c_int;
}
extern "C" fn pax_attribute_acl(mut a: *mut archive_read,
                                mut tar: *mut tar,
                                mut entry: *mut archive_entry,
                                mut value: *const libc::c_char,
    ...
    match type_0 {
        ...
        15360=> {
            errstr = b"SCHILY.acl.ace\x00" as *const u8 as *const libc::c_char
        }
        _ => {
            archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                     ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                     b"Unknown ACL type: %d\x00" as *const u8 as
    ...
    r =
        archive_acl_from_text_l_safe(archive_entry_acl_safe(entry), value, type_0,
                                     safe_tar.sconv_acl);
    if r != ARCHIVE_TAR_DEFINED_PARAM.archive_ok {
 ...
 */
extern "C" fn pax_attribute(mut a: *mut archive_read,
                            mut tar: *mut tar,
                            mut entry: *mut archive_entry,
                            mut key: *const libc::c_char,
                            mut value: *const libc::c_char,
                            mut value_length: size_t) -> libc::c_int {
    let mut s: int64_t =
        0; /* Disable compiler warning; do not pass
    ...
    let mut safe_tar=unsafe{&mut *tar};
    let mut safe_a=unsafe{&mut *a};
    if value.is_null() { value = b"\x00" as *const u8 as *const libc::c_char }
    match unsafe{*key.offset(0 as libc::c_int as isize)} as libc::c_int {
        71 => {
            ...
            if strncmp_safe(key,
                ...
                archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                       ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                       b"Non-regular file cannot be sparse\x00" as
                                           *const u8 as *const libc::c_char);
                return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal
            }
            /* GNU "0.0" sparse pax format. */
            if strcmp_safe(key,
                           b"GNU.sparse.numblocks\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
            ...
            if strcmp_safe(key,
                           b"GNU.sparse.offset\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
                safe_tar.sparse_offset = tar_atol10(value, strlen_safe(value));
                if safe_tar.sparse_numbytes !=
                    -(1 as libc::c_int) as libc::c_long {
                    if gnu_add_sparse_entry(a, tar, safe_tar.sparse_offset,
            ...
            if strcmp_safe(key,
                           b"GNU.sparse.numbytes\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
            ...
            if strcmp_safe(key,
                           b"GNU.sparse.size\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
            ...
            if strcmp_safe(key,
                           b"GNU.sparse.map\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
                safe_tar.sparse_gnu_major = 0 as libc::c_int;
            ...
            if strcmp_safe(key,
                           b"GNU.sparse.major\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
                safe_tar.sparse_gnu_major =
                    tar_atol10(value, strlen_safe(value)) as libc::c_int;
                safe_tar.sparse_gnu_pending = 1 as libc::c_int as libc::c_char
            }
            if strcmp_safe(key,
                           b"GNU.sparse.minor\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
                safe_tar.sparse_gnu_minor =
                    tar_atol10(value, strlen_safe(value)) as libc::c_int;
                safe_tar.sparse_gnu_pending = 1 as libc::c_int as libc::c_char
            }
            if strcmp_safe(key,
                           b"GNU.sparse.name\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
                /*
			 ...
			 * to limit confusion. ;-)
			 */
                safe_tar.entry_pathname_override.length =
                    0 as libc::c_int as size_t;
                archive_strncat_safe(&mut safe_tar.entry_pathname_override,
                                     value as *const libc::c_void,
                                     (if value.is_null() {
                                         0 as libc::c_int as libc::c_ulong
                                     } else { strlen_safe(value) }));
            }
            if strcmp_safe(key,
                           b"GNU.sparse.realsize\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
                safe_tar.realsize = tar_atol10(value, strlen_safe(value));
                archive_entry_set_size_safe(entry, safe_tar.realsize);
                safe_tar.realsize_override = 1 as libc::c_int
        ...
        76 => {
            ...
            */
            if strcmp_safe(key,
                           b"LIBARCHIVE.creationtime\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
                pax_time(value, &mut s, &mut n);
                archive_entry_set_birthtime_safe(entry, s, n);
            }
            if strcmp_safe(key,
                           b"LIBARCHIVE.symlinktype\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
                if strcmp_safe(value,
                               b"file\x00" as *const u8 as *const libc::c_char) ==
                    0 as libc::c_int {
                    archive_entry_set_symlink_type_safe(entry, ARCHIVE_TAR_DEFINED_PARAM.ae_symlink_type_file);
                } else if strcmp_safe(value,
                                      b"dir\x00" as *const u8 as
                                          *const libc::c_char) == 0 as libc::c_int
                {
                    archive_entry_set_symlink_type_safe(entry, ARCHIVE_TAR_DEFINED_PARAM.ae_symlink_type_directory);
                }
            }
            if memcmp_safe(key as *const libc::c_void,
                           b"LIBARCHIVE.xattr.\x00" as *const u8 as
		 ...
		 * SCHILY.xattr.security.selinux == RHT.security.selinux */
            if strcmp_safe(key,
                           b"RHT.security.selinux\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
        ...
        83 => {
            ...
            if strcmp_safe(key,
                           b"SCHILY.acl.access\x00" as *const u8 as
                               *const libc::c_char) == 0 as libc::c_int {
                r =
                    pax_attribute_acl(a, tar, entry, value,
                                      ARCHIVE_TAR_DEFINED_PARAM.archive_entry_acl_type_access);
                if r == ARCHIVE_TAR_DEFINED_PARAM.archive_fatal { return r }
            } else if strcmp_safe(key,
                                  b"SCHILY.acl.default\x00" as *const u8 as
                                      *const libc::c_char) == 0 as libc::c_int {
                r =
                    pax_attribute_acl(a, tar, entry, value,
                ...
                if r == ARCHIVE_TAR_DEFINED_PARAM.archive_fatal { return r }
                                  ...
                                  b"SCHILY.acl.ace\x00" as *const u8 as
                                      *const libc::c_char) == 0 as libc::c_int {
                r =
                    pax_attribute_acl(a, tar, entry, value,
                                      ARCHIVE_TAR_DEFINED_PARAM.archive_entry_acl_type_nfs4);
                if r == ARCHIVE_TAR_DEFINED_PARAM.archive_fatal { return r }
                                  ...
                                  b"SCHILY.devmajor\x00" as *const u8 as
                                      *const libc::c_char) == 0 as libc::c_int {
                archive_entry_set_rdevmajor_safe(entry,
                                                 tar_atol10(value, strlen_safe(value))
                                                     as dev_t);
            } else if strcmp_safe(key,
                                  b"SCHILY.devminor\x00" as *const u8 as
                                      *const libc::c_char) == 0 as libc::c_int {
                archive_entry_set_rdevminor_safe(entry,
                                                 tar_atol10(value, strlen_safe(value))
                                                     as dev_t);
            } else if strcmp_safe(key,
                                  b"SCHILY.fflags\x00" as *const u8 as
                                      *const libc::c_char) == 0 as libc::c_int {
                archive_entry_copy_fflags_text_safe(entry, value);
            } else if strcmp_safe(key,
                                  b"SCHILY.dev\x00" as *const u8 as
                                      *const libc::c_char) == 0 as libc::c_int {
                archive_entry_set_dev_safe(entry,
                                           tar_atol10(value, strlen_safe(value)) as
                                               dev_t);
            } else if strcmp_safe(key,
                                  b"SCHILY.ino\x00" as *const u8 as
                                      *const libc::c_char) == 0 as libc::c_int {
                archive_entry_set_ino_safe(entry,
                                           tar_atol10(value, strlen_safe(value)));
            } else if strcmp_safe(key,
                                  b"SCHILY.nlink\x00" as *const u8 as
                                      *const libc::c_char) == 0 as libc::c_int {
                archive_entry_set_nlink_safe(entry,
                                             tar_atol10(value, strlen_safe(value)) as
                                                 libc::c_uint);
            } else if strcmp_safe(key,
                                  b"SCHILY.realsize\x00" as *const u8 as
                                      *const libc::c_char) == 0 as libc::c_int {
                safe_tar.realsize = tar_atol10(value, strlen_safe(value));
                safe_tar.realsize_override = 1 as libc::c_int;
                archive_entry_set_size_safe(entry, safe_tar.realsize);
            } else if strncmp_safe(key,
                                   b"SCHILY.xattr.\x00" as *const u8 as
                                       *const libc::c_char,
                                   13 as libc::c_int as libc::c_ulong) ==
                0 as libc::c_int {
                pax_attribute_schily_xattr(entry, key, value, value_length);
            } else if strcmp_safe(key,
                                  b"SUN.holesdata\x00" as *const u8 as
                                      *const libc::c_char) == 0 as libc::c_int {
                ...
                if r < err {
                    ...
                    archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                           ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                                           b"Parse error: SUN.holesdata\x00" as
                                               *const u8 as *const libc::c_char);
                }
            }
        }
        ...
        103 => {
            if strcmp_safe(key, b"gid\x00" as *const u8 as *const libc::c_char) ==
                0 as libc::c_int {
                archive_entry_set_gid_safe(entry,
                                           tar_atol10(value, strlen_safe(value)));
            } else if strcmp_safe(key,
                ...
                == 0 as libc::c_int {
                safe_tar.entry_gname.length = 0 as libc::c_int as size_t;
                archive_strncat_safe(&mut safe_tar.entry_gname,
                                     value as *const libc::c_void,
                                     (if value.is_null() {
                                         0 as libc::c_int as libc::c_ulong
                                     } else { strlen_safe(value) }));
            ...
            if strcmp_safe(key,
                ...
                if strcmp_safe(value,
                    ...
                    safe_tar.pax_hdrcharset_binary = 1 as libc::c_int
                                      ...
                                      b"ISO-IR 10646 2000 UTF-8\x00" as *const u8
                                          as *const libc::c_char) ==
                    0 as libc::c_int {
                    safe_tar.pax_hdrcharset_binary = 0 as libc::c_int
                }
        ...
        112 => {
            if strcmp_safe(key, b"path\x00" as *const u8 as *const libc::c_char) ==
                0 as libc::c_int {
                safe_tar.entry_pathname.length = 0 as libc::c_int as size_t;
                archive_strncat_safe(&mut safe_tar.entry_pathname,
                                     value as *const libc::c_void,
                                     (if value.is_null() {
                                         0 as libc::c_int as libc::c_ulong
                                     } else { strlen_safe(value) }));
        ...
        115 => {
            ...
            if strcmp_safe(key, b"size\x00" as *const u8 as *const libc::c_char) ==
                0 as libc::c_int {
        ...
        117 => {
            if strcmp_safe(key, b"uid\x00" as *const u8 as *const libc::c_char) ==
                0 as libc::c_int {
                archive_entry_set_uid_safe(entry,
                                           tar_atol10(value, strlen_safe(value)));
            } else if strcmp_safe(key,
                ...
                == 0 as libc::c_int {
                safe_tar.entry_uname.length = 0 as libc::c_int as size_t;
                archive_strncat_safe(&mut safe_tar.entry_uname,
                                     value as *const libc::c_void,
                                     (if value.is_null() {
                                         0 as libc::c_int as libc::c_ulong
                                     } else { strlen_safe(value) }));
 ...
 */
extern "C" fn pax_time(mut p: *const libc::c_char,
                       mut ps: *mut int64_t,
    ...
    if unsafe{*p as libc::c_int} != '.' as i32 { return }
    ...
    loop  {
        ...
        unsafe {*pn =
            (*pn as
                libc::c_ulong).wrapping_add(((*p as libc::c_int - '0' as i32)
                as
                libc::c_ulong).wrapping_mul(l))
 ...
 */
extern "C" fn header_gnutar(mut a: *mut archive_read,
                            mut tar: *mut tar,
                            mut entry: *mut archive_entry,
                            mut h: *const libc::c_void,
                            mut unconsumed: *mut size_t)
    ...
    if unsafe{*header}.typeflag[0 as libc::c_int as usize] as libc::c_int ==
        ...
        archive_entry_set_rdevminor_safe(entry,
                                         tar_atol(unsafe{*header}.rdevminor.as_ptr(),
                                                  ::std::mem::size_of::<[libc::c_char; 8]>()
                                                      as libc::c_ulong) as dev_t);
    } else { archive_entry_set_rdev_safe(entry, 0 as libc::c_int as dev_t); }
    safe_tar.entry_padding =
        0x1ff as libc::c_int as libc::c_long & -safe_tar.entry_bytes_remaining;
    /* Grab GNU-specific fields. */
    t =
        tar_atol(unsafe{*header}.atime.as_ptr(),
                 ::std::mem::size_of::<[libc::c_char; 12]>() as
                     libc::c_ulong);
    ...
    t =
        tar_atol(unsafe{*header}.ctime.as_ptr(),
                 ::std::mem::size_of::<[libc::c_char; 12]>() as
                     libc::c_ulong);
    if t > 0 as libc::c_int as libc::c_long {
        archive_entry_set_ctime_safe(entry, t, 0 as libc::c_int as libc::c_long);
    }
    if unsafe{*header}.realsize[0 as libc::c_int as usize] as libc::c_int !=
        0 as libc::c_int {
        safe_tar.realsize =
            tar_atol(unsafe{*header}.realsize.as_ptr(),
                     ::std::mem::size_of::<[libc::c_char; 12]>() as
                         libc::c_ulong);
        archive_entry_set_size_safe(entry, safe_tar.realsize);
        safe_tar.realsize_override = 1 as libc::c_int
    }
    if unsafe{*header}.sparse[0 as libc::c_int as
        usize].offset[0 as libc::c_int as usize] as
...
extern "C" fn gnu_add_sparse_entry(mut a: *mut archive_read,
                                   mut tar: *mut tar,
                                   mut offset: int64_t,
    ...
    p =
        calloc_safe(1 as libc::c_int as libc::c_ulong,
                    ::std::mem::size_of::<sparse_block>() as libc::c_ulong) as
            *mut sparse_block;
    if p.is_null() {
        archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                               12 as libc::c_int,
    ...
    if remaining < 0 as libc::c_int as libc::c_long ||
        ...
        archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                               ARCHIVE_TAR_DEFINED_PARAM.archive_errno_misc,
                               b"Malformed sparse map data\x00" as *const u8 as
                                   *const libc::c_char);
        return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal
    }
 ...
 * lot of criticism.
 */
extern "C" fn gnu_sparse_old_read(mut a: *mut archive_read,
                                  mut tar: *mut tar,
                                  mut header:
                                  *const archive_entry_header_gnutar,
                                  mut unconsumed: *mut size_t)
                                  -> libc::c_int {
    let mut bytes_read: ssize_t = 0;
    let mut data: *const libc::c_void = 0 as *const libc::c_void;
    ...
    let mut safe_tar=unsafe{&mut *tar};
    if gnu_sparse_old_parse(a, tar, unsafe{(*header).sparse.as_ptr()},
                            4 as libc::c_int) != ARCHIVE_TAR_DEFINED_PARAM.archive_ok {
        return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal
    }
    if unsafe{(*header).isextended[0 as libc::c_int as usize] as libc::c_int ==
        0 as libc::c_int} {
        return ARCHIVE_TAR_DEFINED_PARAM.archive_ok
    }
    loop  {
        ...
        if bytes_read < 512 as libc::c_int as libc::c_long {
            archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                   ARCHIVE_TAR_DEFINED_PARAM.archive_errno_file_format,
                                   b"Truncated tar archive detected while reading sparse file data\x00"
                                       as *const u8 as *const libc::c_char);
            return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal
        }
        *safe_unconsumed = 512 as libc::c_int as size_t;
        ext = data as *const extended;
        if gnu_sparse_old_parse(a, tar, unsafe{(*ext).sparse.as_ptr()},
                                21 as libc::c_int) != ARCHIVE_TAR_DEFINED_PARAM.archive_ok {
            return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal
        }
        if !unsafe{((*ext).isextended[0 as libc::c_int as usize] as libc::c_int !=
            ARCHIVE_TAR_DEFINED_PARAM.archive_ok)} {
            break ;
        }
    }
...
extern "C" fn gnu_sparse_old_parse(mut a: *mut archive_read,
                                   mut tar: *mut tar,
                                   mut sparse: *const gnu_sparse,
                                   mut length: libc::c_int)
                                   -> libc::c_int {
    while length > 0 as libc::c_int &&
        unsafe {(*sparse).offset[0 as libc::c_int as usize] as libc::c_int !=
            0 as libc::c_int }{
        if gnu_add_sparse_entry(a, tar,
                                tar_atol(unsafe{(*sparse).offset.as_ptr()},
                                         ::std::mem::size_of::<[libc::c_char; 12]>()
                                             as libc::c_ulong),
                                tar_atol(unsafe{(*sparse).numbytes.as_ptr()},
                                         ::std::mem::size_of::<[libc::c_char; 12]>()
                                             as libc::c_ulong)) !=
            ARCHIVE_TAR_DEFINED_PARAM.archive_ok {
            return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal
 ...
 */
extern "C" fn gnu_sparse_01_parse(mut a: *mut archive_read,
                                  mut tar: *mut tar,
    ...
    loop  {
        e = p;
        unsafe{while *e as libc::c_int != '\u{0}' as i32 &&
            *e as libc::c_int != ',' as i32 {
            if (*e as libc::c_int) < '0' as i32 ||
                *e as libc::c_int > '9' as i32 {
                return ARCHIVE_TAR_DEFINED_PARAM.archive_warn
            }
            e = e.offset(1)
        }}
        if offset < 0 as libc::c_int as libc::c_long {
            offset =
                tar_atol10(p,
                           unsafe{e.offset_from(p) as libc::c_long as
                               size_t});
            if offset < 0 as libc::c_int as libc::c_long {
                return ARCHIVE_TAR_DEFINED_PARAM.archive_warn
            }
        ...
        if unsafe{*e as libc::c_int == '\u{0}' as i32} { return ARCHIVE_TAR_DEFINED_PARAM.archive_ok }
 ...
 * negative on error.
 */
extern "C" fn gnu_sparse_10_atol(mut a: *mut archive_read,
                                 mut tar: *mut tar,
    ...
    last_digit_limit =
        9223372036854775807 as libc::c_long % base as libc::c_long;
    loop
    /*
...
*/
    {
        bytes_read =
            readline(a, tar, &mut p,
                     if *safe_remaining < 100 as libc::c_int as libc::c_long {
                         *safe_remaining
                     } else { 100 as libc::c_int as libc::c_long },
                     unconsumed); /* Truncate on overflow. */
        if bytes_read <= 0 as libc::c_int as libc::c_long {
    ...
    while bytes_read > 0 as libc::c_int as libc::c_long {
        ...
        } else { l = l * base as libc::c_long + digit as libc::c_long }
        unsafe {p = p.offset(1)};
        bytes_read -= 1
    }
    /* TODO: Error message. */
 ...
 * that was read.
 */
extern "C" fn gnu_sparse_10_read(mut a: *mut archive_read,
                                 mut tar: *mut tar,
                                 mut unconsumed: *mut size_t)
                                 -> ssize_t {
    let mut bytes_read: ssize_t = 0;
    ...
    /* Parse entries. */
    entries =
        gnu_sparse_10_atol(a, tar, &mut remaining, unconsumed) as libc::c_int;
    if entries < 0 as libc::c_int { return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal as ssize_t }
    loop
    ...
    if to_skip > remaining { return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal as ssize_t }
 ...
 */
extern "C" fn solaris_sparse_parse(mut a: *mut archive_read,
                                   mut tar: *mut tar,
                                   mut entry: *mut archive_entry,
                                   mut p: *const libc::c_char)
                                   -> libc::c_int {
    ...
    if unsafe{*p as libc::c_int == ' ' as i32} {
        unsafe {p = p.offset(1)}
    } else { return ARCHIVE_TAR_DEFINED_PARAM.archive_warn }
    loop  {
        e = p;
        while unsafe{*e as libc::c_int != '\u{0}' as i32 &&
            *e as libc::c_int != ' ' as i32 }{
            if unsafe{(*e as libc::c_int) < '0' as i32 ||
                *e as libc::c_int > '9' as i32} {
                return ARCHIVE_TAR_DEFINED_PARAM.archive_warn
            }
            unsafe {e = e.offset(1)}
        ...
        start = end;
            ...
            tar_atol10(p,
                       unsafe{e.offset_from(p) as libc::c_long as size_t});
 ...
 */
extern "C" fn tar_atol(mut p: *const libc::c_char,
                       mut char_cnt: size_t) -> int64_t {
    /*
 ...
 * it does obey locale.
 */
extern "C" fn tar_atol_base_n(mut p: *const libc::c_char,
                              mut char_cnt: size_t,
                              mut base: libc::c_int) -> int64_t {
    let mut l: int64_t = 0;
    ...
    if char_cnt != 0 as libc::c_int as libc::c_ulong &&
        ...
        limit =
            -((-(9223372036854775807 as libc::c_long) -
                1 as libc::c_int as libc::c_long) / base as libc::c_long);
        last_digit_limit =
            -((-(9223372036854775807 as libc::c_long) -
                1 as libc::c_int as libc::c_long) % base as libc::c_long)
    }
    ...
    if char_cnt != 0 as libc::c_int as libc::c_ulong {
        ...
        while digit >= 0 as libc::c_int && digit < base &&
            ...
            if l > limit ||
                l == limit && digit as libc::c_long >= last_digit_limit {
                return maxval
...
extern "C" fn tar_atol8(mut p: *const libc::c_char,
                        mut char_cnt: size_t) -> int64_t {
    return tar_atol_base_n(p, char_cnt, 8 as libc::c_int);
}
extern "C" fn tar_atol10(mut p: *const libc::c_char,
                         mut char_cnt: size_t) -> int64_t {
 ...
 */
extern "C" fn tar_atol256(mut _p: *const libc::c_char,
                          mut char_cnt: size_t) -> int64_t {
    ...
    while char_cnt > ::std::mem::size_of::<int64_t>() as libc::c_ulong {
        ...
        if c as libc::c_int != neg as libc::c_int {
            return if neg as libc::c_int != 0 {
                (-(9223372036854775807 as libc::c_long)) -
                    1 as libc::c_int as libc::c_long
            } else { 9223372036854775807 as libc::c_long }
        }
        unsafe { p = p.offset(1)};
        c = unsafe{*p}
    }
    ...
    {
        char_cnt = char_cnt.wrapping_sub(1);
        if !(char_cnt > 0 as libc::c_int as libc::c_ulong) { break ; }
 ...
 * when possible.
 */
extern "C" fn readline(mut a: *mut archive_read, mut tar: *mut tar,
                       mut start: *mut *const libc::c_char,
                       mut limit: ssize_t, mut unconsumed: *mut size_t)
                       -> ssize_t {
    ...
    if !p.is_null() {
        bytes_read =
            unsafe {
                (p as
                    *const libc::c_char).offset(1 as libc::c_int as
                    isize).offset_from(s)
                    as libc::c_long};
        if bytes_read > limit {
            archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                   ARCHIVE_TAR_DEFINED_PARAM.archive_errno_file_format,
                                   b"Line too long\x00" as *const u8 as
                                       *const libc::c_char);
            return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal as ssize_t
        }
    ...
    *safe_unconsumed = bytes_read as size_t;
    ...
    /* Otherwise, we need to accumulate in a line buffer. */
    {
        ...
        if archive_string_ensure_safe(&mut safe_tar.line,
                                      (total_size + bytes_read) as
                                          size_t).is_null() {
            archive_set_error_safe!(&mut safe_a.archive as *mut archive,
                                   ARCHIVE_TAR_DEFINED_PARAM.enomem,
                                   b"Can\'t allocate working buffer\x00" as
                                       *const u8 as *const libc::c_char);
            return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal as ssize_t
        }
        memcpy_safe(unsafe{safe_tar.line.s.offset(total_size as isize) as *mut libc::c_void},
                    t, bytes_read as libc::c_ulong);
        tar_flush_unconsumed(a, unconsumed);
        total_size += bytes_read;
        /* If we found '\n', clean up and return. */
        if !p.is_null() { *safe_start = safe_tar.line.s; return total_size }
        /* Read some more. */
        t =
            __archive_read_ahead_safe(a, 1 as libc::c_int as size_t,
                                      &mut bytes_read); /* Start of line? */
        if bytes_read <= 0 as libc::c_int as libc::c_long {
            return ARCHIVE_TAR_DEFINED_PARAM.archive_fatal as ssize_t
        }
        s = t as *const libc::c_char;
 ...
 */
extern "C"  fn base64_decode(mut s: *const libc::c_char,
                             mut len: size_t, mut out_len: *mut size_t)
                             -> *mut libc::c_char {
    ...
    if unsafe{decode_table[digits[1 as libc::c_int as usize] as usize] as libc::c_int}
        != 1 as libc::c_int {
        let mut i: libc::c_uint = 0;
        memset_safe(unsafe{decode_table.as_mut_ptr()} as *mut libc::c_void,
                    0xff as libc::c_int,
                    unsafe {::std::mem::size_of::<[libc::c_uchar; 128]>() as
                        libc::c_ulong});
        i = 0 as libc::c_int as libc::c_uint;
        while (i as libc::c_ulong) <
            unsafe {::std::mem::size_of::<[libc::c_uchar; 64]>() as
                libc::c_ulong} {
    ...
    out =
        malloc_safe(len.wrapping_sub(len.wrapping_div(4 as libc::c_int as
    ...
    while len > 0 as libc::c_int as libc::c_ulong {
        ...
        while group_size < 4 as libc::c_int &&
            ...
            if unsafe{*src as libc::c_int} == '=' as i32 ||
                ...
                break ;
            } else if unsafe{*src as libc::c_int > 127 as libc::c_int ||
                (*src as libc::c_int) < 32 as libc::c_int ||
                decode_table[*src as usize] as libc::c_int ==
                    0xff as libc::c_int} {
        ...
        match group_size {
            4 => {
                unsafe{*d.offset(2 as libc::c_int as isize) =
                    (v & 0xff as libc::c_int) as libc::c_char};
                current_block_23 = 13843085778775597086;
            }
            3 => { current_block_23 = 13843085778775597086; }
            2 => { current_block_23 = 10880025040852361420; }
            1 | _ => { current_block_23 = 8704759739624374314; }
        }
        match current_block_23 {
            13843085778775597086 =>
            /* FALLTHROUGH */
                {
                    unsafe{*d.offset(1 as libc::c_int as isize) =
                        (v >> 8 as libc::c_int & 0xff as libc::c_int) as
                            libc::c_char};
        ...
        match current_block_23 {
            ...
            /* FALLTHROUGH */
                {
                    unsafe {*d.offset(0 as libc::c_int as isize) =
                        (v >> 16 as libc::c_int & 0xff as libc::c_int) as
                            libc::c_char}
                }
            _ => { }
        }
        d =
            unsafe {d.offset((group_size * 3 as libc::c_int / 4 as libc::c_int) as
                isize)}
    }
    unsafe {*out_len = d.offset_from(out) as libc::c_long as size_t};
    return out;
}
extern "C" fn url_decode(mut in_0: *const libc::c_char)
                         -> *mut libc::c_char {
    let mut out: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut d: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut s: *const libc::c_char = 0 as *const libc::c_char;
    out =
        malloc_safe(strlen_safe(in_0).wrapping_add(1 as libc::c_int as libc::c_ulong))
            as *mut libc::c_char;
    if out.is_null() { return 0 as *mut libc::c_char }
    s = in_0;
    d = out;
    while unsafe{*s as libc::c_int }!= '\u{0}' as i32 {
        if unsafe{*s.offset(0 as libc::c_int as isize) as libc::c_int == '%' as i32
            &&
            ...
            *s.offset(2 as libc::c_int as isize) as libc::c_int !=
            ...
            if digit1 >= 0 as libc::c_int && digit2 >= 0 as libc::c_int {
                ...
                unsafe {d = d.offset(1)};
                unsafe {*fresh3 =
                    (digit1 << 4 as libc::c_int | digit2) as libc::c_char};
                continue ;
            }
