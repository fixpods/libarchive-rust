...
pub fn archive_le64dec(mut pp: *const ()) -> uint64_t {
    let mut p: *const u8 = pp as *const u8;
    return (archive_le32dec(unsafe { p.offset(4 as i32 as isize) } as *const ())
        as uint64_t)
        << 32 as i32
...
pub extern "C" fn archive_be64dec(mut pp: *const ()) -> uint64_t {
    ...
    return (archive_be32dec(p as *const ()) as uint64_t) << 32 as i32
        | archive_be32dec(unsafe { p.offset(4 as i32 as isize) as *const () })
            as u64;
}
...
pub extern "C" fn archive_le16enc(mut pp: *mut (), mut u: uint16_t) {
    ...
    unsafe {
        *p.offset(0 as i32 as isize) =
            (u as i32 & 0xff as i32) as u8;
        *p.offset(1 as i32 as isize) =
            (u as i32 >> 8 as i32 & 0xff as i32) as u8;
    }
}
...
pub extern "C" fn archive_le32enc(mut pp: *mut (), mut u: uint32_t) {
    ...
    unsafe {
        *p.offset(0 as i32 as isize) =
            (u & 0xff as i32 as u32) as u8;
        *p.offset(1 as i32 as isize) =
            (u >> 8 as i32 & 0xff as i32 as u32) as u8;
        *p.offset(2 as i32 as isize) =
            (u >> 16 as i32 & 0xff as i32 as u32) as u8;
        *p.offset(3 as i32 as isize) =
            (u >> 24 as i32 & 0xff as i32 as u32) as u8;
    }
}
