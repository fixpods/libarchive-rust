...
unsafe extern "C" fn archive_read_format_ar_bid(
     ...
     */
    h = unsafe { __archive_read_ahead(a, 8 as libc::c_int as size_t, 0 as *mut ssize_t) }; /* Used to hold parsed numbers before validation. */
...
unsafe extern "C" fn _ar_read_header(
    ...
    if unsafe {
        strncmp(
            h.offset(58 as libc::c_int as isize),
    ...
    if safe_a.archive.archive_format == ARCHIVE_AR_DEFINED_PARAM.archive_format_ar_gnu {
        ...
        safe_a.archive.archive_format_name = b"ar (BSD)\x00" as *const u8 as *const libc::c_char
    } else {
        safe_a.archive.archive_format_name = b"ar\x00" as *const u8 as *const libc::c_char
    }
    /*
    ...
    } == 0 as libc::c_int
    {
         ...
         */
        if number > (SIZE_MAX as libc::c_ulong).wrapping_sub(1 as libc::c_int as libc::c_ulong)
        ...
        (safe_ar).entry_bytes_remaining = ((safe_ar).entry_bytes_remaining as libc::c_ulong)
        ...
        p = unsafe { malloc(bsd_name_length.wrapping_add(1 as libc::c_int as libc::c_ulong)) }
            as *mut libc::c_char;
        if p.is_null() {
            archive_set_error_safe!(
                &mut safe_a.archive as *mut archive,
...
unsafe extern "C" fn archive_read_format_ar_read_header(
    ...
    header_data =
        unsafe { __archive_read_ahead(a, 60 as libc::c_int as size_t, 0 as *mut ssize_t) };
...
unsafe extern "C" fn ar_parse_common_header(
    ...
    unsafe {
        ...
        archive_entry_set_mtime(
            ...
            ar_atol10(
                ...
                ARCHIVE_AR_DEFINED_PARAM.ar_date_size as libc::c_uint,
            ) as time_t,
            0 as libc::c_long,
        );
        archive_entry_set_uid(
            ...
            ar_atol10(
                ...
                ARCHIVE_AR_DEFINED_PARAM.ar_uid_size as libc::c_uint,
        ...
        archive_entry_set_gid(
            ...
            ar_atol10(
                ...
                ARCHIVE_AR_DEFINED_PARAM.ar_gid_size as libc::c_uint,
        ...
        archive_entry_set_mode(
            ...
            ar_atol8(
                ...
                ARCHIVE_AR_DEFINED_PARAM.ar_mode_size as libc::c_uint,
            ) as mode_t,
        );
        n = ar_atol10(
    ...
    safe_ar.entry_padding = n.wrapping_rem(2 as libc::c_int as libc::c_ulong) as int64_t;
...
unsafe extern "C" fn archive_read_format_ar_read_data(
    ...
    if safe_ar.entry_bytes_remaining > 0 as libc::c_int as libc::c_long {
        unsafe { *buff = __archive_read_ahead(a, 1 as libc::c_int as size_t, &mut bytes_read) };
...
unsafe extern "C" fn ar_atol8(mut p: *const libc::c_char, mut char_cnt: libc::c_uint) -> uint64_t {
    ...
    limit = (SIZE_MAX).wrapping_div(base as libc::c_ulong);
    last_digit_limit = (SIZE_MAX).wrapping_rem(base as libc::c_ulong);
