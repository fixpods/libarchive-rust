...
extern "C" {
    ...
    pub fn __archive_read_register_format(
        ...
        name: *const libc::c_char,
        bid: Option<
            unsafe extern "C" fn(a: *mut archive_read, best_bid: libc::c_int) -> libc::c_int,
        >,
        options: Option<
            unsafe extern "C" fn(
                a: *mut archive_read,
        ...
        >,
        read_header: Option<
            unsafe extern "C" fn(a: *mut archive_read, entry: *mut archive_entry) -> libc::c_int,
        >,
        read_data: Option<
            unsafe extern "C" fn(
                a: *mut archive_read,
        ...
        >,
        read_data_skip: Option<unsafe extern "C" fn(a: *mut archive_read) -> libc::c_int>,
        seek_data: Option<
            unsafe extern "C" fn(
                a: *mut archive_read,
                offset: int64_t,
        ...
        >,
        cleanup: Option<unsafe extern "C" fn(a: *mut archive_read) -> libc::c_int>,
        format_capabilities: Option<unsafe extern "C" fn(a: *mut archive_read) -> libc::c_int>,
        has_encrypted_entries: Option<unsafe extern "C" fn(a: *mut archive_read) -> libc::c_int>,
    ) -> libc::c_int;
...
pub unsafe fn calloc_safe(nitems: libc::c_ulong, size: libc::c_ulong) -> *mut libc::c_void {
    return unsafe { calloc(nitems, size) };
}

pub unsafe fn free_safe(ptr: *mut libc::c_void) {
    unsafe { free(ptr) };
}

pub unsafe fn strcmp_safe(str1: *const libc::c_char, str2: *const libc::c_char) -> libc::c_int {
    return unsafe { strcmp(str1, str2) };
}

pub unsafe fn strlen_safe(str: *const libc::c_char) -> libc::c_ulong {
...
pub unsafe fn wcslen_safe(str: *const wchar_t) -> libc::c_ulong {
...
pub unsafe fn archive_entry_pathname_safe(entry: *mut archive_entry) -> *const libc::c_char {
...
pub unsafe fn archive_entry_symlink_safe(entry: *mut archive_entry) -> *const libc::c_char {
...
pub unsafe fn archive_entry_set_atime_safe(entry: *mut archive_entry, t: time_t, ns: libc::c_long) {
    unsafe {
...
pub unsafe fn archive_entry_set_ctime_safe(entry: *mut archive_entry, t: time_t, ns: libc::c_long) {
    unsafe {
...
pub unsafe fn archive_entry_set_gname_safe(entry: *mut archive_entry, g: *const libc::c_char) {
    unsafe {
...
pub unsafe fn archive_entry_set_mtime_safe(entry: *mut archive_entry, t: time_t, ns: libc::c_long) {
    unsafe {
...
pub unsafe fn archive_entry_set_uname_safe(entry: *mut archive_entry, name: *const libc::c_char) {
    unsafe {
        archive_entry_set_uname(entry, name);
    }
}

pub unsafe fn archive_entry_set_filetype_safe(entry: *mut archive_entry, _type: libc::c_uint) {
    unsafe {
...
pub unsafe fn archive_entry_set_nlink_safe(entry: *mut archive_entry, nlink: libc::c_uint) {
    unsafe {
...
pub unsafe fn __archive_read_register_format_safe(
    ...
    format_data: *mut libc::c_void,
    name: *const libc::c_char,
    bid: Option<unsafe extern "C" fn(a: *mut archive_read, best_bid: libc::c_int) -> libc::c_int>,
    options: Option<
        unsafe extern "C" fn(
            a: *mut archive_read,
            key: *const libc::c_char,
    ...
    read_data_skip: Option<unsafe extern "C" fn(a: *mut archive_read) -> libc::c_int>,
    seek_data: Option<
        unsafe extern "C" fn(a: *mut archive_read, offset: int64_t, whence: libc::c_int) -> int64_t,
    >,
    cleanup: Option<unsafe extern "C" fn(a: *mut archive_read) -> libc::c_int>,
    format_capabilities: Option<unsafe extern "C" fn(a: *mut archive_read) -> libc::c_int>,
    has_encrypted_entries: Option<unsafe extern "C" fn(a: *mut archive_read) -> libc::c_int>,
...
pub unsafe fn __errno_location_safe() -> *mut libc::c_int {
...
pub unsafe fn BZ2_bzDecompress_safe(strm: *mut bz_stream) -> libc::c_int {
    return unsafe { BZ2_bzDecompress(strm) };
}

pub unsafe fn BZ2_bzDecompressEnd_safe(strm: *mut bz_stream) -> libc::c_int {
...
pub unsafe fn archive_filter_bytes_safe(param1: *mut archive, param2: libc::c_int) -> la_int64_t {
...
pub unsafe fn strrchr_safe(param1: *const libc::c_char, param2: libc::c_int) -> *mut libc::c_char {
...
pub unsafe fn __archive_read_next_passphrase_safe(a: *mut archive_read) -> *const libc::c_char {
...
pub unsafe fn realloc_safe(_a: *mut libc::c_void, _b: libc::c_ulong) -> *mut libc::c_void {
    return unsafe { realloc(_a, _b) };
}

pub unsafe fn strchr_safe(_a: *const libc::c_char, _b: libc::c_int) -> *mut libc::c_char {
...
pub unsafe fn blake2sp_init_safe(S: *mut blake2sp_state, outlen: size_t) -> libc::c_int {
    return unsafe { blake2sp_init(S, outlen) };
}

pub unsafe fn archive_entry_pathname_utf8_safe(_a: *mut archive_entry) -> *const libc::c_char {
...
pub unsafe fn archive_entry_set_symlink_type_safe(_a: *mut archive_entry, _b: libc::c_int) {
...
pub unsafe fn strcpy_safe(
    _var1: *mut libc::c_char,
    _var2: *const libc::c_char,
) -> *mut libc::c_char {
...
pub unsafe fn __archive_errx_safe(retvalue: libc::c_int, msg: *const libc::c_char) -> ! {
...
pub unsafe fn iconv_close_safe(__cd: iconv_t) -> libc::c_int {
    return unsafe { iconv_close(__cd) };
}

pub unsafe fn nl_langinfo_safe(__item: nl_item) -> *mut libc::c_char {
...
pub unsafe fn archive_entry_copy_pathname_safe(_a: *mut archive_entry, _pn: *const libc::c_char) {
...
pub unsafe fn __ctype_b_loc_safe() -> *mut *const libc::c_ushort {
    return unsafe { __ctype_b_loc() };
}

pub unsafe fn archive_string_sprintf_safe(_a: *mut archive_string, _b: *const libc::c_char) {
...
pub unsafe fn xmlTextReaderRead_safe(reader: xmlTextReaderPtr) -> libc::c_int {
    return unsafe { xmlTextReaderRead(reader) };
}

pub unsafe fn xmlTextReaderIsEmptyElement_safe(reader: xmlTextReaderPtr) -> libc::c_int {
    return unsafe { xmlTextReaderIsEmptyElement(reader) };
}

pub unsafe fn xmlTextReaderNodeType_safe(reader: xmlTextReaderPtr) -> libc::c_int {
...
pub unsafe fn xmlTextReaderMoveToFirstAttribute_safe(reader: xmlTextReaderPtr) -> libc::c_int {
    return unsafe { xmlTextReaderMoveToFirstAttribute(reader) };
}

pub unsafe fn xmlTextReaderMoveToNextAttribute_safe(reader: xmlTextReaderPtr) -> libc::c_int {
...
pub unsafe fn archive_entry_copy_gname_safe(_a: *mut archive_entry, _b: *const libc::c_char) {
...
pub unsafe fn archive_entry_copy_link_safe(_a: *mut archive_entry, _b: *const libc::c_char) {
...
pub unsafe fn archive_entry_copy_uname_safe(_a: *mut archive_entry, _b: *const libc::c_char) {
...
pub unsafe fn strdup_safe(_var1: *const libc::c_char) -> *mut libc::c_char {
...
pub unsafe fn fstat_safe(__fd: libc::c_int, __buf: *mut stat) -> libc::c_int {
    return unsafe { fstat(__fd, __buf) };
}

pub unsafe fn lstat_safe(__file: *const libc::c_char, __buf: *mut stat) -> libc::c_int {
    return unsafe { lstat(__file, __buf) };
}

pub unsafe fn open_safe(__file: *const libc::c_char, __oflag: libc::c_int) -> libc::c_int {
    return unsafe { open(__file, __oflag) };
}

pub unsafe fn strcspn_safe(_a1: *const libc::c_char, _a2: *const libc::c_char) -> libc::c_ulong {
    return unsafe { strcspn(_a1, _a2) };
}

pub unsafe fn strnlen_safe(__string: *const libc::c_char, __maxlen: size_t) -> size_t {
    return unsafe { strnlen(__string, __maxlen) };
}

pub unsafe fn close_safe(__fd: libc::c_int) -> libc::c_int {
    return unsafe { close(__fd) };
}

pub unsafe fn read_safe(__fd: libc::c_int, __buf: *mut libc::c_void, __nbytes: size_t) -> ssize_t {
...
pub unsafe fn __archive_ensure_cloexec_flag_safe(fd: libc::c_int) {
    return unsafe { __archive_ensure_cloexec_flag(fd) };
}

pub unsafe fn pack_find_safe(_a1: *const libc::c_char) -> Option<pack_t> {
...
pub unsafe fn archive_entry_nlink_safe(an: *mut archive_entry) -> libc::c_uint {
    return unsafe { archive_entry_nlink(an) };
}

pub unsafe fn archive_entry_copy_hardlink_safe(an: *mut archive_entry, a2: *const libc::c_char) {
...
pub unsafe fn inflateReset_safe(strm: z_streamp) -> libc::c_int {
    return unsafe { inflateReset(strm) };
}

pub unsafe fn inflate_safe(strm: z_streamp, flush: libc::c_int) -> libc::c_int {
    return unsafe { inflate(strm, flush) };
}

pub unsafe fn inflateEnd_safe(strm: z_streamp) -> libc::c_int {
